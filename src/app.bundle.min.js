...
})(
	{
			...
			function (e, t, n) {
				...
				(i = this),
					(r = function (i) {
								...
								((function (e) {
									...
									(o.rgb.hsl = function (e) {
										var t,
											...
											l = s - o;
										return (
											s === o ? (t = 0) : i === s ? (t = (r - a) / l) : r === s ? (t = 2 + (a - i) / l) : a === s && (t = 4 + (i - r) / l),
											(t = Math.min(60 * t, 360)) < 0 && (t += 360),
											(n = (o + s) / 2),
											[t, 100 * (s === o ? 0 : n <= 0.5 ? l / (s + o) : l / (2 - s - o)), 100 * n]
										);
									}),
										(o.rgb.hsv = function (e) {
											...
											return (
												0 == u
													? (a = o = 0)
													: ((o = u / d), (n = t(s)), (i = t(l)), (r = t(c)), s === d ? (a = r - i) : l === d ? (a = 1 / 3 + n - r) : c === d && (a = 2 / 3 + i - n), a < 0 ? (a += 1) : 1 < a && (a -= 1)),
												[360 * a, 100 * o, 100 * d]
											);
										}),
										...
										(o.rgb.xyz = function (e) {
											...
											return [
												100 *
												(0.4124 * (t = 0.04045 < t ? Math.pow((t + 0.055) / 1.055, 2.4) : t / 12.92) +
										...
										(o.rgb.lab = function (e) {
											...
											return (
												...
												[116 * (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16, 500 * (n - i), 200 * (i - (r = 0.008856 < r ? Math.pow(r, 1 / 3) : 7.787 * r + 16 / 116))]
											);
										}),
										(o.hsl.rgb = function (e) {
											...
											(t = 2 * l - (n = l < 0.5 ? l * (1 + s) : l + s - l * s)), (r = [0, 0, 0]);
											for (var c = 0; c < 3; c++)
												(i = o + (1 / 3) * -(c - 1)) < 0 && i++, 1 < i && i--, (a = 6 * i < 1 ? t + 6 * (n - t) * i : 2 * i < 1 ? n : 3 * i < 2 ? t + (n - t) * (2 / 3 - i) * 6 : t), (r[c] = 255 * a);
											return r;
										}),
										...
										(o.xyz.rgb = function (e) {
											...
											return (
												...
												(t = 0.0031308 < (t = 3.2406 * r + -1.5372 * a + -0.4986 * o) ? 1.055 * Math.pow(t, 1 / 2.4) - 0.055 : 12.92 * t),
												(n = 0.0031308 < n ? 1.055 * Math.pow(n, 1 / 2.4) - 0.055 : 12.92 * n),
												(i = 0.0031308 < i ? 1.055 * Math.pow(i, 1 / 2.4) - 0.055 : 12.92 * i),
										...
										(o.xyz.lab = function (e) {
											...
											return (
												...
												[116 * (n = 0.008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (t - n), 200 * (n - (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116))]
											);
										}),
										(o.lab.xyz = function (e) {
											...
											var a = Math.pow(n, 3),
												...
												s = Math.pow(i, 3);
											return (
												(n = 0.008856 < a ? a : (n - 16 / 116) / 7.787), (t = 0.008856 < o ? o : (t - 16 / 116) / 7.787), (i = 0.008856 < s ? s : (i - 16 / 116) / 7.787), [(t *= 95.047), (n *= 100), (i *= 108.883)]
											);
										}),
										...
										(o.hsl.hcg = function (e) {
											var t = e[1] / 100,
												...
												i = 1,
												r = 0;
											return (i = n < 0.5 ? 2 * t * n : 2 * t * (1 - n)) < 1 && (r = (n - 0.5 * i) / (1 - i)), [e[0], 100 * i, 100 * r];
										}),
										...
										(o.hcg.hsl = function (e) {
											var t = e[1] / 100,
												n = (e[2] / 100) * (1 - t) + 0.5 * t,
												i = 0;
											return 0 < n && n < 0.5 ? (i = t / (2 * n)) : 0.5 <= n && n < 1 && (i = t / (2 * (1 - n))), [e[0], 100 * i, 100 * n];
										}),
						...
						function s(e) {
							var t = (function () {
								for (var e = {}, t = Object.keys(c), n = t.length, i = 0; i < n; i++) e[t[i]] = { distance: -1, parent: null };
								return e;
							})(),
								n = [e];
							for (t[e].distance = 0; n.length;)
								for (var i = n.pop(), r = Object.keys(c[i]), a = r.length, o = 0; o < a; o++) {
									var s = r[o],
										l = t[s];
									-1 === l.distance && ((l.distance = t[i].distance + 1), (l.parent = i), n.unshift(s));
								}
							return t;
						}
						function a(t, n) {
							...
							Object.keys(i).forEach(function (e) {
								...
								(r[n][e] = (function (r) {
									function e(e) {
										...
										var t = r(e);
										if ("object" == typeof t) for (var n = t.length, i = 0; i < n; i++) t[i] = Math.round(t[i]);
										return t;
									}
									return "conversion" in r && (e.conversion = r.conversion), e;
								})(t)),
									(r[n][e].raw = (function (t) {
										function e(e) {
										...
										void ("string" == typeof e
											? (t = n.getRgba(e))
												...
												: (t = n.getHsla(e))
													...
													: (t = n.getHwb(e)) && this.setValues("hwb", t)
											: "object" == typeof e &&
						...
						(M.prototype = {
							...
							luminosity: function () {
								for (var e = this.values.rgb, t = [], n = 0; n < e.length; n++) {
									var i = e[n] / 255;
									t[n] = i <= 0.03928 ? i / 12.92 : Math.pow((0.055 + i) / 1.055, 2.4);
								}
						...
						var w,
							...
							S = {
								...
								each: function (e, t, n, i) {
									var r, a, o;
									if (S.isArray(e))
										if (((a = e.length), i)) for (r = a - 1; 0 <= r; r--) t.call(n, e[r], r);
										else for (r = 0; r < a; r++) t.call(n, e[r], r);
									else if (S.isObject(e)) for (a = (o = Object.keys(e)).length, r = 0; r < a; r++) t.call(n, e[o[r]], o[r]);
								},
								...
								merge: function (e, t, n) {
									...
									for (i = (n = n || {}).merger || S._merger, r = 0; r < c; ++r) if (((t = l[r]), S.isObject(t))) for (s = 0, o = (a = Object.keys(t)).length; s < o; ++s) i(a[s], e, t, n);
									return e;
								},
								mergeIf: function (e, t) {
									return S.merge(e, t, { merger: S._mergerIf });
								},
								extend:
									Object.assign ||
									function (e) {
						...
						var k = {
							...
							easeInElastic: function (e) {
								var t = 1.70158,
									n = 0,
									i = 1;
								return 0 === e ? 0 : 1 === e ? 1 : ((n = n || 0.3), (t = i < 1 ? ((i = 1), n / 4) : (n / (2 * Math.PI)) * Math.asin(1 / i)), -i * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e - t) * (2 * Math.PI)) / n));
							},
							easeOutElastic: function (e) {
								var t = 1.70158,
									n = 0,
									i = 1;
								return 0 === e ? 0 : 1 === e ? 1 : ((n = n || 0.3), (t = i < 1 ? ((i = 1), n / 4) : (n / (2 * Math.PI)) * Math.asin(1 / i)), i * Math.pow(2, -10 * e) * Math.sin(((e - t) * (2 * Math.PI)) / n) + 1);
							},
							easeInOutElastic: function (e) {
								...
								return 0 === e
									...
									: 2 == (e /= 0.5)
										? 1
										: ((n = n || 0.45),
											(t = i < 1 ? ((i = 1), n / 4) : (n / (2 * Math.PI)) * Math.asin(1 / i)),
							...
							V = {
								...
								roundedRect: function (e, t, n, i, r, a) {
									if (a) {
										...
										e.moveTo(t, l),
											s < c && l < d
												? (e.arc(s, l, o, -L, -A), e.arc(c, l, o, -A, 0), e.arc(c, d, o, 0, A), e.arc(s, d, o, A, L))
												: s < c
													? (e.moveTo(s, n), e.arc(c, l, o, -A, A), e.arc(s, l, o, A, L + A))
													: l < d
														? (e.arc(s, l, o, -L, 0), e.arc(s, d, o, 0, L))
														: e.arc(s, l, o, -L, L),
											e.closePath(),
											e.moveTo(t, n);
									} else e.rect(t, n, i, r);
								...
								drawPoint: function (e, t, n, i, r, a) {
									...
									if (t && "object" == typeof t && ("[object HTMLImageElement]" === (o = t.toString()) || "[object HTMLCanvasElement]" === o))
										return e.save(), e.translate(i, r), e.rotate(u), e.drawImage(t, -t.width / 2, -t.height / 2, t.width, t.height), void e.restore();
									if (!(isNaN(n) || n <= 0)) {
										switch ((e.beginPath(), t)) {
											default:
												e.arc(i, r, n, 0, O), e.closePath();
												break;
											case "triangle":
												e.moveTo(i + Math.sin(u) * n, r - Math.cos(u) * n), (u += D), e.lineTo(i + Math.sin(u) * n, r - Math.cos(u) * n), (u += D), e.lineTo(i + Math.sin(u) * n, r - Math.cos(u) * n), e.closePath();
												break;
											case "rectRounded":
												(c = n - (d = 0.516 * n)),
													(s = Math.cos(u + P) * c),
													(l = Math.sin(u + P) * c),
													e.arc(i - s, r - l, d, u - L, u - A),
													e.arc(i + l, r - s, d, u - A, u),
													e.arc(i + s, r + l, d, u, u + A),
													e.arc(i - l, r + s, d, u + A, u + L),
													e.closePath();
												break;
											case "rect":
												if (!a) {
												...
												u += P;
											case "rectRot":
												(s = Math.cos(u) * n), (l = Math.sin(u) * n), e.moveTo(i - s, r - l), e.lineTo(i + l, r - s), e.lineTo(i + s, r + l), e.lineTo(i - l, r + s), e.closePath();
												break;
											case "crossRot":
												u += P;
											case "cross":
												(s = Math.cos(u) * n), (l = Math.sin(u) * n), e.moveTo(i - s, r - l), e.lineTo(i + s, r + l), e.moveTo(i + l, r - s), e.lineTo(i - l, r + s);
												break;
											case "star":
												(s = Math.cos(u) * n),
													(l = Math.sin(u) * n),
												...
												break;
											case "line":
												(s = Math.cos(u) * n), (l = Math.sin(u) * n), e.moveTo(i - s, r - l), e.lineTo(i + s, r + l);
												break;
											case "dash":
												e.moveTo(i, r), e.lineTo(i + Math.cos(u) * n, r + Math.sin(u) * n);
										}
										e.fill(), e.stroke();
									}
								},
						...
						var N = {
							...
							toPadding: function (e) {
								var t, n, i, r;
								return (
									C.isObject(e) ? ((t = +e.top || 0), (n = +e.right || 0), (i = +e.bottom || 0), (r = +e.left || 0)) : (t = n = i = r = +e || 0), { top: t, right: n, bottom: i, left: r, height: t + i, width: r + n }
								);
							},
							_parseFont: function (e) {
								var t = H.global,
									n = B(e.fontSize, t.defaultFontSize),
									i = {
										family: B(e.fontFamily, t.defaultFontFamily),
										lineHeight: C.options.toLineHeight(B(e.lineHeight, t.defaultLineHeight), n),
										size: n,
										style: B(e.fontStyle, t.defaultFontStyle),
										weight: null,
										string: "",
									};
								return (
							...
							resolve: function (e, t, n, i) {
								...
								for (r = 0, a = e.length; r < a; ++r)
									if (void 0 !== (o = e[r]) && (void 0 !== t && "function" == typeof o && ((o = o(t)), (s = !1)), void 0 !== n && C.isArray(o) && ((o = o[n]), (s = !1)), void 0 !== o))
							...
							transition: function (e) {
								...
								return (
									n && 1 !== e
										...
										: ((t._view = W.extend({}, n)), (t._start = null)),
									t
								);
							},
						...
						Object.defineProperty(Z.prototype, "animationObject", {
							...
							H._set("global", { animation: { duration: 1e3, easing: "easeOutQuart", onProgress: W.noop, onComplete: W.noop } });
						var J = {
							animations: [],
							request: null,
							addAnimation: function (e, t, n, i) {
								var r,
									a,
									o = this.animations;
								for (t.chart = e, t.startTime = Date.now(), t.duration = n, i || (e.animating = !0), r = 0, a = o.length; r < a; ++r) if (o[r].chart === e) return void (o[r] = t);
							...
							requestAnimationFrame: function () {
								var e = this;
								null === e.request &&
									(e.request = W.requestAnimFrame.call(window, function () {
							...
							advance: function () {
								for (var e, t, n, i, r = this.animations, a = 0; a < r.length;)
									(t = (e = r[a]).chart),
										(n = e.numSteps),
										(i = Math.floor(((Date.now() - e.startTime) / e.duration) * n) + 1),
										(e.currentStep = Math.min(i, n)),
										W.callback(e.render, [t, e], t),
										W.callback(e.onAnimationProgress, [e], t),
										e.currentStep >= n ? (W.callback(e.onAnimationComplete, [e], t), (t.animating = !1), r.splice(a, 1)) : ++a;
							},
						},
							Q = W.options.resolve,
						...
						W.extend(ne.prototype, {
							...
							buildOrUpdateElements: function () {
								var e = this,
									...
									n = t.data || (t.data = []);
								e._data !== n &&
									(e._data && te(e._data, e),
										n &&
										Object.isExtensible(n) &&
										(function (r, e) {
											r._chartjs
												? r._chartjs.listeners.push(e)
												: (Object.defineProperty(r, "_chartjs", { configurable: !0, enumerable: !1, value: { listeners: [e] } }),
													ee.forEach(function (e) {
														...
														Object.defineProperty(r, e, {
															...
															value: function () {
																var t = Array.prototype.slice.call(arguments),
																	e = i.apply(this, t);
																return (
																	W.each(r._chartjs.listeners, function (e) {
							...
							getStyle: function (e) {
								...
								return (
									this._configure(),
									(!1 !== (t = i && void 0 === e ? this._resolveDatasetElementOptions(i || {}) : ((e = e || 0), this._resolveDataElementOptions(n.data[e] || {}, e))).fill && null !== t.fill) ||
							...
							_resolveDataElementOptions: function (e, t) {
								...
								var a,
									...
									p = { cacheable: !i };
								if (((i = i || {}), W.isArray(h))) for (o = 0, s = h.length; o < s; ++o) f[(l = h[o])] = Q([i[l], d[l], u[l]], g, t, p);
								else for (o = 0, s = (a = Object.keys(h)).length; o < s; ++o) f[(l = a[o])] = Q([i[l], d[h[l]], d[l], u[l]], g, t, p);
							...
							setHoverStyle: function (e) {
								var t = this.chart.data.datasets[e._datasetIndex],
									...
									r = e._model,
									a = W.getHoverColor;
								(e.$previousStyle = { backgroundColor: r.backgroundColor, borderColor: r.borderColor, borderWidth: r.borderWidth }),
									(r.backgroundColor = Q([i.hoverBackgroundColor, t.hoverBackgroundColor, a(r.backgroundColor)], void 0, n)),
									(r.borderColor = Q([i.hoverBorderColor, t.hoverBorderColor, a(r.borderColor)], void 0, n)),
									(r.borderWidth = Q([i.hoverBorderWidth, t.hoverBorderWidth, r.borderWidth], void 0, n));
							},
						...
						function ae(e, t) {
							var n = t.startAngle,
								...
								s = t.y;
							e.beginPath(),
								e.arc(o, s, t.outerRadius, n - a, i + a),
								t.innerRadius > r ? ((a = r / t.innerRadius), e.arc(o, s, t.innerRadius - r, i + a, n - a, !0)) : e.arc(o, s, r, i + Math.PI / 2, n - Math.PI / 2),
								e.closePath(),
								e.clip();
						}
						function oe(e, t, n) {
							var i = "inner" === t.borderAlign;
							i ? ((e.lineWidth = 2 * t.borderWidth), (e.lineJoin = "round")) : ((e.lineWidth = t.borderWidth), (e.lineJoin = "bevel")),
								n.fullCircles &&
								(function (e, t, n, i) {
									var r,
										a = n.endAngle;
									for (
										i && ((n.endAngle = n.startAngle + re), ae(e, n), (n.endAngle = a), n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += re), n.fullCircles--)),
										e.beginPath(),
						...
						H._set("global", { elements: { arc: { backgroundColor: H.global.defaultColor, borderColor: "#fff", borderWidth: 2, borderAlign: "center" } } });
						var se = $.extend({
							_type: "arc",
							...
							draw: function () {
								...
								if ((t.save(), (t.fillStyle = n.backgroundColor), (t.strokeStyle = n.borderColor), r.fullCircles)) {
									for (
										r.endAngle = r.startAngle + re, t.beginPath(), t.arc(r.x, r.y, r.outerRadius, r.startAngle, r.endAngle), t.arc(r.x, r.y, r.innerRadius, r.endAngle, r.startAngle, !0), t.closePath(), e = 0;
										e < r.fullCircles;
										++e
									)
										t.fill();
							...
							le = W.valueOrDefault,
							ce = H.global.defaultColor;
						H._set("global", {
							elements: { line: { tension: 0.4, backgroundColor: ce, borderWidth: 3, borderColor: ce, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } },
						});
						var de = $.extend({
							_type: "line",
							draw: function () {
								...
								if (s.length) {
									...
									for (
										...
										a.lineDashOffset = le(r.borderDashOffset, c.borderDashOffset),
										a.lineJoin = r.borderJoinStyle || c.borderJoinStyle,
										a.lineWidth = le(r.borderWidth, c.borderWidth),
										a.strokeStyle = r.borderColor || l.defaultColor,
										a.beginPath(),
										(n = s[0]._view).skip || (a.moveTo(n.x, n.y), (d = 0)),
										e = 1;
										e < s.length;
										++e
									)
										(n = s[e]._view), (t = -1 === d ? W.previousItem(s, e) : s[d]), n.skip || ((d !== e - 1 && !o) || -1 === d ? a.moveTo(n.x, n.y) : W.canvas.lineTo(a, t._view, n), (d = e));
									u && a.closePath(), a.stroke(), a.restore();
								}
							},
						}),
							ue = W.valueOrDefault,
							he = H.global.defaultColor;
						function fe(e) {
							var t = this._view;
							return !!t && Math.abs(e - t.x) < t.radius + t.hitRadius;
						}
						H._set("global", { elements: { point: { radius: 3, pointStyle: "circle", backgroundColor: he, borderColor: he, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 } } });
						var ge = $.extend({
							_type: "point",
							inRange: function (e, t) {
								var n = this._view;
							...
							draw: function (e) {
								var t = this._view,
									...
									c = l.defaultColor;
								t.skip ||
									(void 0 !== e && !W.canvas._isPointInArea(t, e)) ||
									((n.strokeStyle = t.borderColor || c), (n.lineWidth = ue(t.borderWidth, l.elements.point.borderWidth)), (n.fillStyle = t.backgroundColor || c), W.canvas.drawPoint(n, i, a, o, s, r));
							},
						}),
							pe = H.global.defaultColor;
						function ve(e) {
						...
						function me(e) {
							...
							return (
								(r = ve(e)
									? ((a = e.width / 2), (t = e.x - a), (n = e.x + a), (i = Math.min(e.y, e.base)), Math.max(e.y, e.base))
									: ((a = e.height / 2), (t = Math.min(e.x, e.base)), (n = Math.max(e.x, e.base)), (i = e.y - a), e.y + a)),
						...
						function be(e, t, n) {
							...
							return (
								W.isObject(s) ? ((i = +s.top || 0), (r = +s.right || 0), (a = +s.bottom || 0), (o = +s.left || 0)) : (i = r = a = o = +s || 0),
								{ t: l.top || i < 0 ? 0 : n < i ? n : i, r: l.right || r < 0 ? 0 : t < r ? t : r, b: l.bottom || a < 0 ? 0 : n < a ? n : a, l: l.left || o < 0 ? 0 : t < o ? t : o }
							);
						}
						function xe(e, t, n) {
							var i = null === t,
						...
						H._set("global", { elements: { rectangle: { backgroundColor: pe, borderColor: pe, borderSkipped: "bottom", borderWidth: 0 } } });
						var Me = $.extend({
							_type: "rectangle",
							draw: function () {
								...
								(e.fillStyle = t.backgroundColor),
									...
									(i.w === r.w && i.h === r.h) || (e.save(), e.beginPath(), e.rect(i.x, i.y, i.w, i.h), e.clip(), (e.fillStyle = t.borderColor), e.rect(r.x, r.y, r.w, r.h), e.fill("evenodd"), e.restore());
							},
							height: function () {
								var e = this._view;
								return e.base - e.y;
							...
							getCenterPoint: function () {
								var e,
									t,
									n = this._view;
								return (t = ve(n) ? ((e = n.x), (n.y + n.base) / 2) : ((e = (n.x + n.base) / 2), n.y)), { x: e, y: t };
							},
							getArea: function () {
								var e = this._view;
						...
						H._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }),
							H._set("global", { datasets: { bar: { categoryPercentage: 0.8, barPercentage: 0.9 } } });
						var Oe = ie.extend({
							...
							initialize: function () {
								var e,
									t,
									n = this;
								ie.prototype.initialize.apply(n, arguments),
									((e = n.getMeta()).stack = n.getDataset().stack),
									(e.bar = !0),
									(t = n._getIndexScale().options),
									Te("bar chart", t.barPercentage, "scales.[x/y]Axes.barPercentage", "dataset.barPercentage"),
									Te("bar chart", t.barThickness, "scales.[x/y]Axes.barThickness", "dataset.barThickness"),
									Te("bar chart", t.categoryPercentage, "scales.[x/y]Axes.categoryPercentage", "dataset.categoryPercentage"),
									Te("bar chart", n._getValueScale().options.minBarLength, "scales.[x/y]Axes.minBarLength", "dataset.minBarLength"),
									Te("bar chart", t.maxBarThickness, "scales.[x/y]Axes.maxBarThickness", "dataset.maxBarThickness");
							},
							update: function (e) {
								var t,
									n,
							...
							updateElement: function (e, t, n) {
								...
								(e._xScale = i.getScaleForId(r.xAxisID)),
									...
									(e._index = t),
									(e._model = { backgroundColor: o.backgroundColor, borderColor: o.borderColor, borderSkipped: o.borderSkipped, borderWidth: o.borderWidth, datasetLabel: a.label, label: i.chart.data.labels[t] }),
									W.isArray(a.data[t]) && (e._model.borderSkipped = null),
									i._updateElementGeometry(e, t, n, o),
									e.pivot();
							},
							...
							calculateBarValuePixels: function (e, t, n) {
								...
								if (m || (void 0 === m && void 0 !== y))
									for (i = 0; i < M && (r = g[i]).index !== e; ++i)
										r.stack === y && ((a = void 0 === (c = u._parseValue(f[r.index].data[t])).start ? c.end : 0 <= c.min && 0 <= c.max ? c.max : c.min), ((p.min < 0 && a < 0) || (0 <= p.max && 0 < a)) && (b += a));
								return (
									(o = u.getPixelForValue(b)),
									(l = (s = u.getPixelForValue(b + x)) - o),
									void 0 !== v && Math.abs(l) < v && ((l = v), (s = (0 <= x && !h) || (x < 0 && h) ? o - v : o + v)),
								...
								var r =
									"flex" === i.barThickness
										? (function (e, t, n) {
											...
											return (
												null === o && (o = a - (null === s ? t.end - t.start : s - a)),
												null === s && (s = a + a - o),
												(i = a - ((a - Math.min(o, s)) / 2) * l),
												{ chunk: ((Math.abs(s - o) / 2) * l) / t.stackCount, ratio: n.barPercentage, start: i }
											);
										})(t, n, i)
										: Ee(t, n, i),
							...
							_resolveDataElementOptions: function () {
								...
								return (
									(e.barPercentage = Le(t.barPercentage, e.barPercentage)),
									(e.barThickness = Le(t.barThickness, e.barThickness)),
									(e.categoryPercentage = Le(t.categoryPercentage, e.categoryPercentage)),
									(e.maxBarThickness = Le(t.maxBarThickness, e.maxBarThickness)),
									(e.minBarLength = Le(n.minBarLength, e.minBarLength)),
									e
								);
							},
						}),
						...
						var De = ie.extend({
							...
							updateElement: function (e, t, n) {
								var i = this,
									...
									d = i.index,
									u = n ? o.getPixelForDecimal(0.5) : o.getPixelForValue("object" == typeof c ? c : NaN, t, d),
							...
							setHoverStyle: function (e) {
								var t = e._model,
									n = e._options,
									i = W.getHoverColor;
								(e.$previousStyle = { backgroundColor: t.backgroundColor, borderColor: t.borderColor, borderWidth: t.borderWidth, radius: t.radius }),
							...
							legendCallback: function (e) {
								...
								if ((r.setAttribute("class", e.id + "-legend"), o.length))
									for (n = o[(t = 0)].data.length; t < n; ++t)
										((i = r.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = o[0].backgroundColor[t]), s[t] && i.appendChild(document.createTextNode(s[t]));
								return r.outerHTML;
							},
							legend: {
								labels: {
						...
						var Be = ie.extend({
							...
							update: function (e) {
								...
								if (v < ze) {
									var y = l.rotation % ze,
										...
										E = S ? 1 : Math.max(x, x * p, w, w * p),
										O = C ? 1 : Math.max(M, M * p, _, _ * p);
									(c = (E - T) / 2), (d = (O - L) / 2), (u = -(E + T) / 2), (h = -(O + L) / 2);
								}
								for (i = 0, r = g.length; i < r; ++i) g[i]._options = a._resolveDataElementOptions(g[i], i);
								for (
									o.borderWidth = a.getMaxBorderWidth(),
									t = (s.right - s.left - o.borderWidth) / c,
							...
							getMaxBorderWidth: function (e) {
								...
								for (t = 0, n = e.length; t < n; ++t)
									(r = e[t]), "inner" !== (o = a ? (a._configure(), a._resolveDataElementOptions(r, t)) : r._options).borderAlign && (c = (c = c < (s = o.borderWidth) ? s : c) < (l = o.hoverBorderWidth) ? l : c);
								return c;
							},
							setHoverStyle: function (e) {
								var t = e._model,
									n = e._options,
									i = W.getHoverColor;
								(e.$previousStyle = { backgroundColor: t.backgroundColor, borderColor: t.borderColor, borderWidth: t.borderWidth }),
						...
						H._set("horizontalBar", {
							...
							H._set("global", { datasets: { horizontalBar: { categoryPercentage: 0.8, barPercentage: 0.9 } } });
						var Ne = Oe.extend({
							_getValueScaleId: function () {
								return this.getMeta().xAxisID;
							},
						...
						H._set("line", { showLines: !0, spanGaps: !1, hover: { mode: "label" }, scales: { xAxes: [{ type: "category", id: "x-axis-0" }], yAxes: [{ type: "linear", id: "y-axis-0" }] } });
						var Ye = ie.extend({
							...
							update: function (e) {
								...
								for (
									...
									(void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension),
										...
										(a._children = o),
										(a._model = i._resolveDatasetElementOptions(a)),
										a.pivot()),
									t = 0,
									n = o.length;
									t < n;
							...
							updateElement: function (e, t, n) {
								...
								(i = u.getPixelForValue("object" == typeof d ? d : NaN, t, c)),
							...
							_resolveDatasetElementOptions: function (e) {
								...
								return (
									(o.spanGaps = Ie(n.spanGaps, r.spanGaps)),
									(o.tension = Ie(n.lineTension, a.tension)),
									(o.steppedLine = Fe([i.steppedLine, n.steppedLine, a.stepped])),
									(o.clip = (function (e) {
										var t, n, i, r;
										return W.isObject(e) ? ((t = e.top), (n = e.right), (i = e.bottom), (r = e.left)) : (t = n = i = r = e), { top: t, right: n, bottom: i, left: r };
									})(
										Ie(
											n.clip,
											(function (e, t, n) {
											...
											})(t._xScale, t._yScale, o.borderWidth)
										)
									)),
									o
								);
							...
							calculatePointY: function (e, t, n) {
								...
								if (u.options.stacked) {
									for (s = +u.getRightValue(e), c = (l = d._getSortedVisibleDatasetMetas()).length, i = 0; i < c && (a = l[i]).index !== n; ++i)
										(r = d.data.datasets[a.index]), "line" === a.type && a.yAxisID === u.id && ((o = +u.getRightValue(r.data[t])) < 0 ? (f += o || 0) : (h += o || 0));
							...
							updateBezierControlPoints: function () {
								...
								if (
									...
									for (e = 0, t = l.length; e < t; ++e)
										(n = l[e]._model),
											(i = W.splineCurve(W.previousItem(l, e)._model, n, W.nextItem(l, e)._model, o.tension)),
								...
								if (r.options.elements.line.capBezierPoints)
									for (e = 0, t = l.length; e < t; ++e)
										(n = l[e]._model),
											We(n, s) &&
											(0 < e && We(l[e - 1]._model, s) && ((n.controlPointPreviousX = c(n.controlPointPreviousX, s.left, s.right)), (n.controlPointPreviousY = c(n.controlPointPreviousY, s.top, s.bottom))),
												e < l.length - 1 && We(l[e + 1]._model, s) && ((n.controlPointNextX = c(n.controlPointNextX, s.left, s.right)), (n.controlPointNextY = c(n.controlPointNextY, s.top, s.bottom))));
							},
							draw: function () {
								var e,
									t = this.chart,
							...
							setHoverStyle: function (e) {
								var t = e._model,
									...
									i = W.getHoverColor;
								(e.$previousStyle = { backgroundColor: t.backgroundColor, borderColor: t.borderColor, borderWidth: t.borderWidth, radius: t.radius }),
									(t.backgroundColor = Ie(n.hoverBackgroundColor, i(n.backgroundColor))),
									(t.borderColor = Ie(n.hoverBorderColor, i(n.borderColor))),
						...
						H._set("pie", W.clone(H.doughnut)), H._set("pie", { cutoutPercentage: 0 });
						var qe = Be,
							Xe = W.valueOrDefault;
						H._set("radar", { spanGaps: !1, scale: { type: "radialLinear" }, elements: { line: { fill: "start", tension: 0 } } });
						var $e = ie.extend({
							datasetElementType: we.Line,
							dataElementType: we.Point,
							linkScales: W.noop,
							...
							updateBezierControlPoints: function () {
								...
								for (
									...
									(n = o[e]._model),
										(i = W.splineCurve(W.previousItem(o, e, !0)._model, n, W.nextItem(o, e, !0)._model, n.tension)),
							...
							setHoverStyle: function (e) {
								var t = e._model,
									...
									i = W.getHoverColor;
								(e.$previousStyle = { backgroundColor: t.backgroundColor, borderColor: t.borderColor, borderWidth: t.borderWidth, radius: t.radius }),
									(t.backgroundColor = Xe(n.hoverBackgroundColor, i(n.backgroundColor))),
									(t.borderColor = Xe(n.hoverBorderColor, i(n.borderColor))),
									(t.borderWidth = Xe(n.hoverBorderWidth, n.borderWidth)),
									(t.radius = Xe(n.hoverRadius, n.radius));
							},
						});
						H._set("scatter", {
							hover: { mode: "single" },
							...
							H._set("global", { datasets: { scatter: { showLine: !1 } } });
						var Ze = { bar: Oe, bubble: De, doughnut: Be, horizontalBar: Ne, line: Ye, polarArea: Ue, pie: qe, radar: $e, scatter: Ye };
						function Ke(e, t) {
							return e.native ? { x: e.x, y: e.y } : W.getRelativePosition(e, t);
						}
						function Je(e, t) {
							var n,
								i,
							...
							for (i = 0, a = l.length; i < a; ++i) for (r = 0, o = (n = l[i].data).length; r < o; ++r) (s = n[r])._view.skip || t(s);
						}
						function Qe(e, t) {
							var n = [];
							return (
						...
						function ut(e, t, n) {
							...
							for (i = 0, r = e.length; i < r; ++i)
								(o = (a = e[i]).box),
									a.horizontal
										? ((o.left = o.fullWidth ? s.left : t.left), (o.right = o.fullWidth ? n.outerWidth - s.right : t.left + t.w), (o.top = c), (o.bottom = c + o.height), (o.width = o.right - o.left), (c = o.bottom))
										: ((o.left = l), (o.right = l + o.width), (o.top = t.top), (o.bottom = t.top + t.h), (o.height = o.bottom - o.top), (l = o.right));
							(t.x = l), (t.y = c);
						}
						H._set("global", { layout: { padding: { top: 0, right: 0, bottom: 0, left: 0 } } });
						var ht,
							ft = {
								defaults: {},
								addBox: function (e, t) {
								...
								update: function (n, e, t) {
									if (n) {
											...
											s = (function (e) {
												var t = (function (e) {
													var t,
														...
														i,
														r = [];
													for (t = 0, n = (e || []).length; t < n; ++t) (i = e[t]), r.push({ index: t, box: i, pos: i.position, horizontal: i.isHorizontal(), weight: i.weight });
													return r;
												})(e),
													n = ot(at(t, "left"), !0),
													i = ot(at(t, "right")),
										...
										!(function (e, t) {
											...
											(u.x += u.w),
											(u.y += u.h),
											ut(s.rightAndBottom, u, d),
											(n.chartArea = { left: u.left, top: u.top, right: u.left + u.w, bottom: u.top + u.h }),
							...
							var a = n[pt] || (n[pt] = {}),
								t = (a.resizer = (function (e) {
									...
									return (
										...
										St(n, "scroll", r.bind(n, "expand")),
										St(i, "scroll", r.bind(i, "shrink")),
										t
									);
								})(
									(function (e, t) {
										...
										return function () {
											(i = Array.prototype.slice.call(arguments)),
												...
												n ||
												((n = !0),
													W.requestAnimFrame.call(window, function () {
														(n = !1), e.apply(t, i);
													}));
										};
									})(function () {
						...
						var At = Ot._enabled
							...
							Pt = W.extend({ initialize: function () { }, acquireContext: function () { }, releaseContext: function () { }, addEventListener: function () { }, removeEventListener: function () { } }, At);
						H._set("global", { plugins: {} });
						var Dt = {
							_plugins: [],
							_cacheId: 0,
							register: function (e) {
							...
							notify: function (e, t, n) {
								var i,
									...
									c = l.length;
								for (i = 0; i < c; ++i) if ("function" == typeof (s = (a = (r = l[i]).plugin)[t]) && ((o = [e].concat(n || [])).push(r.options), !1 === s.apply(a, o))) return !1;
								return !0;
							},
								...
								return (
									this._plugins.concat(n.plugins || []).forEach(function (e) {
										if (-1 === i.indexOf(e)) {
											var t = e.id,
												n = a[t];
											!1 !== n && (!0 === n && (n = W.clone(H.global.plugins[t])), i.push(e), r.push({ plugin: e, options: n || {} }));
										}
									}),
									(t.descriptors = r),
									(t.id = this._cacheId),
							...
							Vt = {
								...
								getScaleDefaults: function (e) {
									return this.defaults.hasOwnProperty(e) ? W.merge({}, [H.scale, this.defaults[e]]) : {};
								},
						...
						var jt = $.extend({
							...
							getTitle: function () {
								var e = this._options.callbacks,
									...
									r = [];
								return (r = Bt((r = Bt((r = Bt(r, Nt(t))), Nt(n))), Nt(i)));
							},
							...
							getBody: function (e, n) {
								...
								return (
									W.each(e, function (e) {
										...
										Bt(t.before, Nt(r.beforeLabel.call(i, e, n))), Bt(t.lines, r.label.call(i, e, n)), Bt(t.after, Nt(r.afterLabel.call(i, e, n))), a.push(t);
									}),
									a
								);
							},
							...
							update: function (e) {
								...
								if (p.length) {
									...
									var M = [],
										w = [];
									x = Ht[h.position].call(u, p, u._eventPosition);
									var _ = [];
									...
									h.filter &&
										...
										(g.title = u.getTitle(_, v)),
										(g.beforeBody = u.getBeforeBody(_, v)),
										(g.body = u.getBody(_, v)),
										(g.afterBody = u.getAfterBody(_, v)),
										(g.footer = u.getFooter(_, v)),
										(g.x = x.x),
										(g.y = x.y),
										...
										(y = (function (e, t, n, i) {
											var r = e.x,
												...
												h = l + s;
											return (
												"right" === c ? (r -= t.width) : "center" === c && ((r -= t.width / 2) + t.width > i.width && (r = i.width - t.width), r < 0 && (r = 0)),
												"top" === d ? (a += u) : (a -= "bottom" === d ? t.height + u : t.height / 2),
												"center" === d ? ("left" === c ? (r += u) : "right" === c && (r -= u)) : "left" === c ? (r -= h) : "right" === c && (r += h),
												{ x: r, y: a }
											);
										})(
											g,
											(b = (function (e, t) {
												...
												var f = 0;
												return (
													(n.font = W.fontString(c, t._titleFontStyle, t._titleFontFamily)),
													W.each(t.title, h),
													(n.font = W.fontString(d, t._bodyFontStyle, t._bodyFontFamily)),
													W.each(t.beforeBody.concat(t.afterBody), h),
													(f = t.displayColors ? d + 2 : 0),
													W.each(a, function (e) {
														W.each(e.before, h), W.each(e.lines, h), W.each(e.after, h);
													}),
													(f = 0),
													(n.font = W.fontString(u, t._footerFontStyle, t._footerFontFamily)),
													W.each(t.footer, h),
							...
							drawTitle: function (e, t, n) {
								...
								if (s) {
									...
									for (
										...
										n.font = W.fontString(i, t._titleFontStyle, t._titleFontFamily),
										a = 0;
										a < s;
										++a
									)
										n.fillText(o[a], l.x(e.x), e.y + i / 2), (e.y += i + r), a + 1 === s && (e.y += t.titleMarginBottom - r);
								}
							},
							drawBody: function (t, e, n) {
								...
								for (
									n.textAlign = g,
									n.textBaseline = "middle",
									n.font = W.fontString(h, e._bodyFontStyle, e._bodyFontFamily),
									t.x = Ft(e, x),
									n.fillStyle = e.bodyFontColor,
									W.each(e.beforeBody, i),
									m = v && "right" !== x ? ("center" === g ? h / 2 + 1 : h + 2) : 0,
									l = 0,
									d = p.length;
									l < d;
									++l
									...
									for (r = p[l], a = e.labelTextColors[l], o = e.labelColors[l], n.fillStyle = a, W.each(r.before, i), c = 0, u = (s = r.lines).length; c < u; ++c) {
										if (v) {
											...
											(n.fillStyle = e.legendColorBackground),
												n.fillRect(b.leftForLtr(M, h), t.y, h, h),
												(n.lineWidth = 1),
												(n.strokeStyle = o.borderColor),
												n.strokeRect(b.leftForLtr(M, h), t.y, h, h),
												(n.fillStyle = o.backgroundColor),
												n.fillRect(b.leftForLtr(b.xPlus(M, 1), h - 2), t.y + 1, h - 2, h - 2),
												(n.fillStyle = a);
										}
										i(s[c]);
									}
							...
							drawFooter: function (e, t, n) {
								...
								if (o) {
									...
									for (
										e.x = Ft(t, t._footerAlign),
										e.y += t.footerMarginTop,
										n.textAlign = s.textAlign(t._footerAlign),
										n.textBaseline = "middle",
										i = t.footerFontSize,
										n.fillStyle = t.footerFontColor,
										n.font = W.fontString(i, t._footerFontStyle, t._footerFontFamily),
										r = 0;
										r < o;
										++r
									)
										n.fillText(a[r], s.x(e.x), e.y + i / 2), (e.y += i + t.footerSpacing);
								}
							},
								...
								if (0 !== t.opacity) {
									...
									this._options.enabled &&
										...
										(e.save(),
											...
											(i.y += t.yPadding),
											W.rtl.overrideTextDirection(e, t.textDirection),
											this.drawTitle(i, t, e),
											this.drawBody(i, t, e),
											this.drawFooter(i, t, e),
											W.rtl.restoreTextDirection(e, t.textDirection),
											e.restore());
								}
							},
							handleEvent: function (e) {
								...
								return (
									...
									"mouseout" === e.type ? (n._active = []) : ((n._active = n._chart.getElementsAtEventForMode(e, i.mode, i)), i.reverse && n._active.reverse()),
									(t = !W.arrayEquals(n._active, n._lastActive)) && ((n._lastActive = n._active), (i.enabled || i.custom) && ((n._eventPosition = { x: e.x, y: e.y }), n.update(!0), n.pivot())),
									t
								);
							},
						}),
								...
								merger: function (e, t, n, i) {
									if ("xAxes" === e || "yAxes" === e) {
										...
										for (t[e] || (t[e] = []), r = 0; r < s; ++r)
											(o = n[e][r]),
												(a = Ut(o.type, "xAxes" === e ? "category" : "linear")),
												r >= t[e].length && t[e].push({}),
												!t[e][r].type || (o.type && o.type !== t[e][r].type) ? W.merge(t[e][r], [Vt.getScaleDefaults(a), o]) : W.merge(t[e][r], o);
						...
						W.extend(Jt.prototype, {
							construct: function (e, t) {
								...
								t = (function (e) {
									...
									return (t.datasets = t.datasets || []), (t.labels = t.labels || []), (e.options = Xt(H.global, H[e.type], e.options || {})), e;
								})(t);
							...
							buildOrUpdateScales: function () {
								...
								e.scales &&
									...
									e.scale && t.push({ options: e.scale, dtype: "radialLinear", isDefault: !0, dposition: "chartArea" }),
									W.each(t, function (e) {
										var t = e.options,
											n = t.id,
											i = Ut(t.type, e.dtype);
							...
							buildOrUpdateControllers: function () {
								...
								for (e = 0, t = r.length; e < t; e++) {
									...
									if ((o.type && o.type !== s && (n.destroyDatasetMeta(e), (o = n.getDatasetMeta(e))), (o.type = s), (o.order = a.order || 0), (o.index = e), o.controller))
							...
							update: function (e) {
								...
								if (
									((e && "object" == typeof e) || (e = { duration: e, lazy: arguments[1] }),
										(function (t) {
											...
											W.each(t.scales, function (e) {
												...
												(e = Xt(H.global, H[t.config.type], e)),
									...
									i.updateLayout(),
										...
										(i.lastActive = []),
										Dt.notify(i, "afterUpdate"),
										i._layers.sort(Kt("z", "_idx")),
										i._bufferedRender ? (i._bufferedRequest = { duration: e.duration, easing: e.easing, lazy: e.lazy }) : i.render(e);
								}
							},
							updateLayout: function () {
								var t = this;
								!1 !== Dt.notify(t, "beforeLayout") &&
									(ft.update(this, this.width, this.height),
										...
										Dt.notify(t, "afterScaleUpdate"),
										Dt.notify(t, "afterLayout"));
							},
							...
							bindEvents: function () {
								...
								W.each(t.options.events, function (e) {
									...
									((i = function () {
										...
										Pt.addEventListener(t, "resize", i),
										(n.resize = i));
							},
							...
							handleEvent: function (e) {
								...
								return (
									...
									W.callback(i.onHover || i.hover.onHover, [e.native, n.active], n),
									("mouseup" !== e.type && "click" !== e.type) || (i.onClick && i.onClick.call(n, e.native, n.active)),
									n.lastActive.length && n.updateHoverStyle(n.lastActive, r.mode, !1),
									n.active.length && r.mode && n.updateHoverStyle(n.active, r.mode, !0),
									(t = !W.arrayEquals(n.active, n.lastActive)),
						...
						function dn(e, t, n, i) {
							...
							for (r = 0; r < m; ++r) {
								if (((s = n[r].label), (l = n[r].major ? t.major : t.minor), (e.font = c = l.string), (d = i[c] = i[c] || { data: {}, gc: [] }), (u = l.lineHeight), (h = f = 0), on(s) || an(s))) {
									if (an(s)) for (a = 0, o = s.length; a < o; ++a) (g = s[a]), on(g) || an(g) || ((h = W.measureText(e, d.data, d.gc, h, g)), (f += u));
							...
							return (
								...
								(v = b.indexOf(Math.max.apply(null, b))),
								{ first: M(0), last: M(m - 1), widest: M(p), highest: M(v) }
							);
						}
						function un(e) {
						...
						function fn(e, t) {
							return W.extend(W.options._parseFont({ fontFamily: sn(t.fontFamily, e.fontFamily), fontSize: sn(t.fontSize, e.fontSize), fontStyle: sn(t.fontStyle, e.fontStyle), lineHeight: sn(t.lineHeight, e.lineHeight) }), {
								color: W.options.resolve([t.fontColor, e.fontColor, H.global.defaultFontColor]),
							});
						}
						function gn(e) {
							var t = fn(e, e.minor);
							return { minor: t, major: e.major.enabled ? fn(e, e.major) : t };
						}
						function pn(e) {
							var t,
								n,
						...
						var mn = $.extend({
							...
							update: function (e, t, n) {
								...
								if (
									(l.beforeUpdate(),
										(l.maxWidth = e),
										(l.maxHeight = t),
										(l.margins = W.extend({ left: 0, right: 0, top: 0, bottom: 0 }, n)),
										(l._ticks = null),
										(l.ticks = null),
										(l._labelSizes = null),
										(l._maxLabelLines = 0),
								...
								return (
									...
									l.fit(),
									l.afterFit(),
									(l._ticksToDraw = c.display && (c.autoSkip || "auto" === c.source) ? l._autoSkip(o) : o),
							...
							calculateTickRotation: function () {
								var e,
									...
									h = c.maxRotation,
									f = u;
								!s._isVisible() || !c.display || h <= u || d <= 1 || !s.isHorizontal()
									? (s.labelRotation = u)
									: ((t = (e = s._getLabelSizes()).widest.width),
										(n = e.highest.height - e.highest.offset),
										(i = Math.min(s.maxWidth, s.chart.width - t)),
										(r = l.offset ? s.maxWidth / d : i / (d - 1)) < t + 6 &&
										((r = i / (d - (l.offset ? 0.5 : 1))),
											(a = s.maxHeight - un(l.gridLines) - c.padding - hn(l.scaleLabel)),
											(o = Math.sqrt(t * t + n * n)),
											(f = W.toDegrees(Math.min(Math.asin(Math.min((e.highest.height + 6) / r, 1)), Math.asin(Math.min(a / o, 1)) - Math.asin(n / o)))),
											(f = Math.max(u, Math.min(h, f)))),
										(s.labelRotation = f));
							},
							...
							fit: function () {
								...
								if ((c ? (t.width = e.maxWidth) : s && (t.width = un(o) + hn(a)), c ? s && (t.height = un(o) + hn(a)) : (t.height = e.maxHeight), r.display && s)) {
									...
									if (c) {
										...
										(S = y ? ((_ = l ? x * h.width + M * h.offset : M * (h.height - h.offset)), l ? M * (f.height - f.offset) : x * f.width + M * f.offset) : ((_ = h.width / 2), f.width / 2)),
											(e.paddingLeft = Math.max(((_ - C) * e.width) / (e.width - C), 0) + 3),
											(e.paddingRight = Math.max(((S - k) * e.width) / (e.width - k), 0) + 3);
									} else {
								...
								e.handleMargins(),
									c ? ((e.width = e._length = n.width - e.margins.left - e.margins.right), (e.height = t.height)) : ((e.width = t.width), (e.height = e._length = n.height - e.margins.top - e.margins.bottom));
							},
							...
							_parseValue: function (e) {
								var t, n, i, r;
								return (
									(r = an(e) ? ((t = +this.getRightValue(e[0])), (n = +this.getRightValue(e[1])), (i = Math.min(t, n)), Math.max(t, n)) : ((t = void 0), (i = n = e = +this.getRightValue(e)))),
									{ min: i, max: r, start: t, end: n }
								);
							},
							...
							_autoSkip: function (e) {
								...
								if (
									((i = (function (e, t, n, i) {
										...
										for (o = 0, s = (r = W.math._factorize(l)).length - 1; o < s; o++) if (c < (a = r[o])) return a;
										return Math.max(c, 1);
									})(l, e, 0, s)),
										0 < c)
								) {
							...
							_computeGridLineItems: function (e) {
								...
								var n,
									...
									L = un(w),
									E = [],
									O = w.drawBorder ? ln(w.lineWidth, 0, 0) : 0,
									A = O / 2,
									P = W._alignPixel;
								for (
									"top" === _
										? ((n = t(b.bottom)), (l = b.bottom - L), (d = n - A), (h = t(e.top) + A), (g = e.bottom))
										: "bottom" === _
											? ((n = t(b.top)), (h = e.top), (g = t(e.bottom) - A), (l = n + A), (d = b.top + L))
											: "left" === _
												? ((n = t(b.right)), (s = b.right - L), (c = n - A), (u = t(e.left) + A), (f = e.right))
												: ((n = t(b.left)), (u = e.left), (f = t(e.right) - A), (s = n + A), (c = b.left + L)),
									i = 0;
									i < T;
									++i
								)
									(r = k[i] || {}),
										(on(r.label) && i < k.length) ||
										((y =
											i === b.zeroLineIndex && M.offset === S
												? ((p = w.zeroLineWidth), (v = w.zeroLineColor), (m = w.zeroLineBorderDash || []), w.zeroLineBorderDashOffset || 0)
												: ((p = ln(w.lineWidth, i, 1)), (v = ln(w.color, i, "rgba(0,0,0,0.1)")), (m = w.borderDash || []), w.borderDashOffset || 0)),
											void 0 !== (a = cn(b, r._index || i, S)) &&
											((o = P(x, a, p)),
												C ? (s = c = u = f = o) : (l = d = h = g = o),
												E.push({ tx1: s, ty1: l, tx2: c, ty2: d, x1: u, y1: h, x2: f, y2: g, width: p, color: v, borderDash: m, borderDashOffset: y })));
								return (E.ticksLength = T), (E.borderValue = n), E;
							},
							_computeLabelItems: function () {
								...
								for (
									o =
									"top" === p
										? ((a = h.bottom - M - x), w ? "left" : "center")
										: "bottom" === p
											? ((a = h.top + M + x), w ? "right" : "center")
											: "left" === p
												? ((r = h.right - (v ? 0 : M) - x), v ? "left" : "right")
												: ((r = h.left + (v ? 0 : M) + x), v ? "right" : "left"),
									e = 0,
									t = y.length;
									e < t;
									++e
									...
									(i = (n = y[e]).label),
										on(i) ||
										((s = h.getPixelForTick(n._index || e) + g.labelOffset),
											(c = (l = n.major ? b.major : b.minor).lineHeight),
											(d = an(i) ? i.length : 1),
											(u = m ? ((r = s), "top" === p ? ((w ? 1 : 0.5) - d) * c : (w ? 0 : 0.5) * c) : ((a = s), ((1 - d) * c) / 2)),
											_.push({ x: r, y: a, rotation: w, label: i, font: l, textOffset: u, textAlign: o }));
								return _;
							},
								...
								if (n.display) {
									...
									if (u) {
										var f,
											...
											b = h.borderValue;
										t.isHorizontal() ? ((f = d(c, t.left, m) - m / 2), (g = d(c, t.right, y) + y / 2), (p = v = b)) : ((p = d(c, t.top, m) - m / 2), (v = d(c, t.bottom, y) + y / 2), (f = g = b)),
											(l.lineWidth = u),
											(l.strokeStyle = ln(n.color, 0)),
											l.beginPath(),
											l.moveTo(f, p),
											l.lineTo(g, v),
											l.stroke();
							...
							_drawTitle: function () {
								...
								if (i.display) {
									var r,
										a,
										o = sn(i.fontColor, H.global.defaultFontColor),
									...
									if (e.isHorizontal()) (r = e.left + e.width / 2), (a = "bottom" === d ? e.bottom - c - l.bottom : e.top + c + l.top);
										...
										var h = "left" === d;
										(r = h ? e.left + c + l.top : e.right - c - l.top), (a = e.top + e.height / 2), (u = h ? -0.5 * Math.PI : 0.5 * Math.PI);
									}
							...
							xn = yn.extend({
								...
								_configure: function () {
									var e = this,
										t = e.options.offset,
										n = e.ticks;
									yn.prototype._configure.call(e), e.isHorizontal() || (e._reversePixels = !e._reversePixels), n && ((e._startValue = e.minIndex - (t ? 0.5 : 0)), (e._valueRange = Math.max(n.length - (t ? 0 : 1), 1)));
								},
								getPixelForValue: function (e, t, n) {
									var i,
										...
										o = this;
									return (
										bn(t) || bn(n) || (e = o.chart.data.datasets[n].data[t]),
										bn(e) || (i = o.isHorizontal() ? e.x : e.y),
										(void 0 !== i || (void 0 !== e && isNaN(t))) && ((r = o._getLabels()), (e = W.valueOrDefault(i, e)), (t = -1 !== (a = r.indexOf(e)) ? a : t), isNaN(t) && (t = e)),
						...
						var Sn = yn.extend({
							...
							handleTickRangeOptions: function () {
								...
								void 0 !== t.min ? (e.min = t.min) : void 0 !== t.suggestedMin && (null === e.min ? (e.min = t.suggestedMin) : (e.min = Math.min(e.min, t.suggestedMin))),
									...
									r != a && e.min >= e.max && (r ? (e.max = e.min + 1) : (e.min = e.max - 1)),
							...
							buildTicks: function () {
								var e = this,
									...
									r = (e.ticks = (function (e, t) {
										...
										c < (a = Math.ceil(g / p) - Math.floor(f / p)) && (p = W.niceNum((a * p) / c / l) * l),
											s || _n(h) ? (n = Math.pow(10, W._decimalPlaces(p))) : ((n = Math.pow(10, h)), (p = Math.ceil(p * n) / n)),
											(i = Math.floor(f / p) * p),
											(r = Math.ceil(g / p) * p),
											s && (!_n(d) && W.almostWhole(d / p, p / 1e3) && (i = d), !_n(u) && W.almostWhole(u / p, p / 1e3) && (r = u)),
											(a = (r - i) / p),
											(a = W.almostEquals(a, Math.round(a), p / 1e3) ? Math.round(a) : Math.ceil(a)),
											(i = Math.round(i * n) / n),
											(r = Math.round(r * n) / n),
											o.push(_n(d) ? i : d);
						...
						function kn(e, t, n, i) {
							...
							for (r = 0; r < d; ++r)
								(a = e._parseValue(i[r])),
									isNaN(a.min) || isNaN(a.max) || n.data[r].hidden || ((l[r] = l[r] || 0), (c[r] = c[r] || 0), o.relativePoints ? (l[r] = 100) : a.min < 0 || a.max < 0 ? (c[r] += a.min) : (l[r] += a.max));
						}
						function Tn(e, t, n) {
							var i,
								r,
						...
						var Ln = Sn.extend({
							determineDataLimits: function () {
								var e,
									...
									c = {},
									d = s.length;
								if (((r.min = Number.POSITIVE_INFINITY), (r.max = Number.NEGATIVE_INFINITY), void 0 === l)) for (e = 0; !l && e < d; ++e) l = void 0 !== (t = s[e]).stack;
								...
								W.each(c, function (e) {
									...
									(r.min = W.isFinite(r.min) && !isNaN(r.min) ? r.min : 0),
									(r.max = W.isFinite(r.max) && !isNaN(r.max) ? r.max : 1),
						...
						var Vn = yn.extend({
								...
								if (s.stacked || h) {
									...
									for (e = 0; e < c.length; e++)
										if (((t = l.getDatasetMeta(e)), l.isDatasetVisible(e) && u(t)))
											for (r = 0, a = (i = c[e].data).length; r < a; r++)
												(n = o._parseValue(i[r])),
													isNaN(n.min) ||
													isNaN(n.max) ||
													t.data[r].hidden ||
							...
							handleTickRangeOptions: function () {
								var e = this,
									t = e.options.ticks;
								(e.min = Dn(t.min, e.min)),
									(e.max = Dn(t.max, e.max)),
									e.min === e.max && (0 !== e.min && null !== e.min ? ((e.min = Math.pow(10, Math.floor(An(e.min)) - 1)), (e.max = Math.pow(10, Math.floor(An(e.max)) + 1))) : ((e.min = 1), (e.max = 10))),
									null === e.min && (e.min = Math.pow(10, Math.floor(An(e.max)) - 1)),
									null === e.max && (e.max = 0 !== e.min ? Math.pow(10, Math.floor(An(e.min)) + 1) : 10),
									null === e.minNotZero && (0 < e.min ? (e.minNotZero = e.min) : e.max < 1 ? (e.minNotZero = Math.pow(10, Math.floor(An(e.max)))) : (e.minNotZero = 1));
							},
							buildTicks: function () {
								var e = this,
									t = e.options.ticks,
									...
									r = (e.ticks = (function (e, t) {
										var n,
											i,
											r = [],
											a = On(e.min, Math.pow(10, Math.floor(An(t.min)))),
											o = Math.floor(An(t.max)),
											s = Math.ceil(t.max / Math.pow(10, o));
										0 === a
											? ((n = Math.floor(An(t.minNotZero))), (i = Math.floor(t.minNotZero / Math.pow(10, n))), r.push(a), (a = i * Math.pow(10, n)))
											: ((n = Math.floor(An(a))), (i = Math.floor(a / Math.pow(10, n))));
							...
							_configure: function () {
								...
								yn.prototype._configure.call(e),
									0 === t && ((t = e._getFirstTickValue(e.minNotZero)), (n = On(e.options.ticks.fontSize, H.global.defaultFontSize) / e._length)),
									(e._startValue = An(t)),
									(e._valueOffset = n),
									(e._valueRange = (An(e.max) - An(t)) / (1 - n));
							},
							getPixelForValue: function (e) {
								var t = this,
									n = 0;
								return (e = +t.getRightValue(e)) > t.min && 0 < e && (n = (An(e) - t._startValue) / t._valueRange + t._valueOffset), t.getPixelForDecimal(n);
							},
							getValueForPixel: function (e) {
								var t = this,
						...
						function In(e) {
							var t = e.ticks;
							return t.display && e.display ? zn(t.fontSize, H.global.defaultFontSize) + 2 * t.backdropPaddingY : 0;
						}
						function Fn(e, t, n, i, r) {
							return e === i || e === r ? { start: t - n / 2, end: t + n / 2 } : e < i || r < e ? { start: t - n, end: t } : { start: t, end: t + n };
						}
						function Wn(e, t, n, i) {
							var r,
								a,
								o = n.y + i / 2;
							if (W.isArray(t)) for (r = 0, a = t.length; r < a; ++r) e.fillText(t[r], n.x, o), (o += i);
								...
								e.display && e.pointLabels.display
									? (function (e) {
										var t,
											n,
											i,
											r = W.options._parseFont(e.options.pointLabels),
										...
										var s,
											l,
											c,
											d = e.chart.data.labels.length;
										for (t = 0; t < d; t++) {
											(i = e.getPointPosition(t, e.drawingArea + 5)),
												(s = e.ctx),
												(l = r.lineHeight),
												(c = e.pointLabels[t]),
												(n = W.isArray(c) ? { w: W.longestText(s, s.font, c), h: c.length * l } : { w: s.measureText(c).width, h: l }),
							...
							_drawGrid: function () {
								...
								if (
										...
										(function (e) {
											...
											for (var u = e.chart.data.labels.length - 1; 0 <= u; u--) {
												var h = 0 === u ? l / 2 : 0,
													...
													g = Hn(s.fontColor, u, H.global.defaultFontColor);
												a.fillStyle = g;
												var p = e.getIndexAngle(u),
													v = W.toDegrees(p);
												(a.textAlign = 0 === (r = v) || 180 === r ? "center" : r < 180 ? "left" : "right"),
													(t = v),
													(n = e._pointLabelSizes[u]),
													(i = f),
													90 === t || 270 === t ? (i.y -= n.h / 2) : (270 < t || t < 90) && (i.y -= n.h),
													Wn(a, e.pointLabels[u], f, d.lineHeight);
											}
											a.restore();
										})(i),
										o.display &&
										W.each(i.ticks, function (e, t) {
											0 !== t &&
												((n = i.getDistanceFromCenterForValue(i.ticksAsNumbers[t])),
													(function (e, t, n, i) {
														var r,
															a = e.ctx,
															o = t.circular,
															...
															l = Hn(t.color, i - 1),
															c = Hn(t.lineWidth, i - 1);
														if ((o || s) && l && c) {
															if ((a.save(), (a.strokeStyle = l), (a.lineWidth = c), a.setLineDash && (a.setLineDash(t.borderDash || []), (a.lineDashOffset = t.borderDashOffset || 0)), a.beginPath(), o))
									...
									for (
										...
										r.lineWidth = l,
										r.strokeStyle = c,
										r.setLineDash && (r.setLineDash(Bn([s.borderDash, o.borderDash, []])), (r.lineDashOffset = Bn([s.borderDashOffset, o.borderDashOffset, 0]))),
										e = i.chart.data.labels.length - 1;
										0 <= e;
										e--
									)
										(n = i.getDistanceFromCenterForValue(a.ticks.reverse ? i.min : i.max)), (t = i.getPointPosition(e, n)), r.beginPath(), r.moveTo(i.xCenter, i.yCenter), r.lineTo(t.x, t.y), r.stroke();
									r.restore();
								}
							},
							_drawLabels: function () {
								...
								if (r.display) {
									var a,
										...
										l = zn(r.fontColor, H.global.defaultFontColor);
									i.save(),
										(i.font = s.string),
										...
										W.each(n.ticks, function (e, t) {
											(0 === t && !r.reverse) ||
												((a = n.getDistanceFromCenterForValue(n.ticksAsNumbers[t])),
													r.showLabelBackdrop &&
													((o = i.measureText(e).width),
														(i.fillStyle = r.backdropColor),
														i.fillRect(-o / 2 - r.backdropPaddingX, -a - s.size / 2 - r.backdropPaddingY, o + 2 * r.backdropPaddingX, s.size + 2 * r.backdropPaddingY)),
													(i.fillStyle = l),
													i.fillText(e, 0, -a));
										}),
										i.restore();
						...
						function ii(e, t) {
							...
							return (
								...
								W.isFinite(o) || (o = "string" == typeof a ? n.parse(o, a) : n.parse(o)),
								null !== o ? +o : (r || "function" != typeof a || ((o = a(t)), W.isFinite(o) || (o = n.parse(o))), o)
							);
						}
						function ri(e, t) {
						...
						function ai(e, t, n, i) {
							var r,
								...
								o,
								s = Jn.length;
							for (r = Jn.indexOf(e); r < s - 1; ++r) if (((o = (a = Kn[Jn[r]]).steps ? a.steps : Zn), a.common && Math.ceil((n - t) / (o * a.size)) <= i)) return Jn[r];
							return Jn[s - 1];
						}
						function oi(e, t, n) {
							var i,
						...
						var si = yn.extend({
							...
							update: function () {
								...
								return (
									Un("time scale", t.format, "time.format", "time.parser"),
									Un("time scale", t.min, "time.min", "ticks.min"),
									Un("time scale", t.max, "time.max", "ticks.max"),
									W.mergeIf(t.displayFormats, n.formats()),
									yn.prototype.update.apply(this, arguments)
								);
							},
							getRightValue: function (e) {
							...
							determineDataLimits: function () {
								...
								for (e = 0, n = (l.data.datasets || []).length; e < n; ++e)
									if (l.isDatasetVisible(e))
										if (((r = l.data.datasets[e].data), W.isObject(r[0]))) for (p[e] = [], t = 0, i = r.length; t < i; ++t) (a = ri(s, r[t])), g.push(a), (p[e][t] = a);
										else (p[e] = v.slice(0)), o || ((g = g.concat(v)), (o = !0));
									else p[e] = [];
								v.length && ((h = Math.min(h, v[0])), (f = Math.max(f, v[v.length - 1]))),
									g.length &&
									((g =
										1 < n
											? (function (e) {
									...
									(h = ri(s, ei(d)) || h),
									(f = ri(s, ti(d)) || f),
									(h = h === Zn ? +c.startOf(Date.now(), u) : h),
									(f = f === $n ? +c.endOf(Date.now(), u) + 1 : f),
									(s.min = Math.min(h, f)),
							...
							buildTicks: function () {
								...
								for (
									...
									"ticks" === o.bounds && c.length && ((r = c[0]), (a = c[c.length - 1])),
									r = ri(i, ei(o)) || r,
									a = ri(i, ti(o)) || a,
									e = 0,
									t = c.length;
								...
								return (
									...
									(i._unit =
										l.unit ||
										(s.autoSkip
											? ai(l.minUnit, i.min, i.max, u)
											: (function (e, t, n, i, r) {
												var a, o;
												for (a = Jn.length - 1; a >= Jn.indexOf(n); a--) if (((o = Jn[a]), Kn[o].common && e._adapter.diff(r, i, o) >= t - 1)) return o;
												return Jn[n ? Jn.indexOf(n) : 0];
											})(i, d.length, l.minUnit, i.min, i.max))),
									(i._majorUnit =
										s.major.enabled && "year" !== i._unit
											? (function (e) {
												for (var t = Jn.indexOf(e) + 1, n = Jn.length; t < n; ++t) if (Kn[Jn[t]].common) return Jn[t];
											})(i._unit)
											: void 0),
									(i._table = (function (e, t, n, i) {
										...
										for (d.push(n), r = 0, a = d.length; r < a; ++r)
											(l = d[r + 1]), (o = d[r - 1]), (s = d[r]), (void 0 !== o && void 0 !== l && Math.round((l + o) / 2) === s) || c.push({ time: s, pos: r / (a - 1) });
										return c;
									})(i._timestamps.data, r, a, f)),
									(i._offsets = (function (e, t, n, i, r) {
										...
										return (
											...
											t.length &&
											((a = ni(e, "time", t[0], "pos")),
												(s = 1 === t.length ? 1 - a : (ni(e, "time", t[1], "pos") - a) / 2),
												(o = ni(e, "time", t[t.length - 1], "pos")),
												(l = 1 === t.length ? o : (o - ni(e, "time", t[t.length - 2], "pos")) / 2)),
							...
							_getLabelSize: function (e) {
								var t = this.options.ticks,
									...
									r = Math.cos(i),
									a = Math.sin(i),
									o = Xn(t.fontSize, H.global.defaultFontSize);
						...
						nn._date.override(
							...
							H._set("global", { plugins: { filler: { propagate: !0 } } });
						var ui = {
							dataset: function (e) {
								var t = e.fill,
									n = e.chart,
							...
							boundary: function (e) {
								...
								return W.isArray(n)
									...
									: function (e) {
										return { x: null === t ? e.x : t, y: null === i ? e.y : i };
									};
							},
						};
						function hi(e, t, n) {
							...
							return (e.el._scale || {}).getPointPositionForValue
								? (function (e) {
									var t,
										...
										d = [];
									if (!l) return null;
									for (t = s.ticks.reverse ? o.max : o.min, n = s.ticks.reverse ? o.min : o.max, i = o.getPointPositionForValue(0, t), r = 0; r < l; ++r)
										(a = "start" === c || "end" === c ? o.getPointPositionForValue(r, "start" === c ? t : n) : o.getBasePosition(r)),
											s.gridLines.circular && ((a.cx = i.x), (a.cy = i.y), (a.angle = o.getIndexAngle(r) - Math.PI / 2)),
											d.push(a);
									return d;
								})(e)
								: (function (e) {
									...
									if (
										...
										if (W.isFinite(a)) return { x: (t = i.isHorizontal()) ? a : null, y: t ? null : a };
									}
									return null;
								})(e);
						}
						...
						function vi(e, t, n, i, r) {
							...
							if (i && r) {
								...
								if (void 0 === n[0].angle) for (e.lineTo(n[r - 1].x, n[r - 1].y), a = r - 1; 0 < a; --a) W.canvas.lineTo(e, n[a], n[a - 1], !0);
								else for (o = n[0].cx, s = n[0].cy, l = Math.sqrt(Math.pow(n[0].x - o, 2) + Math.pow(n[0].y - s, 2)), a = r - 1; 0 < a; --a) e.arc(o, s, l, n[a].angle, n[a - 1].angle, !0);
							}
						}
						function mi(e, t, n, i, r, a) {
							var o,
								...
								y = 0,
								b = 0;
							for (e.beginPath(), o = 0, s = g; o < s; ++o)
								(d = n((c = t[(l = o % g)]._view), l, i)),
									(u = pi(c)),
									(h = pi(d)),
									a && void 0 === f && u && (s = g + (f = o + 1)),
									u && h ? ((y = v.push(c)), (b = m.push(d))) : y && b && (p ? (u && v.push(c), h && m.push(d)) : (vi(e, v, m, y, b), (y = b = 0), (v = []), (m = [])));
						...
						var yi = {
							...
							afterDatasetsUpdate: function (e, t) {
								var n,
									...
									u = [];
								for (i = 0; i < c; ++i)
									(a = null), (r = (n = e.getDatasetMeta(i)).dataset) && r._model && r instanceof we.Line && (a = { visible: e.isDatasetVisible(i), fill: hi(r, i, c), chart: e, el: r }), (n.$filler = a), u.push(a);
								for (i = 0; i < c; ++i)
									(a = u[i]) && ((a.fill = gi(u, i, d)), (a.boundary = fi(a)), (a.mapper = ((l = void 0), (s = (o = a).fill), !(l = "dataset") === s ? null : (isFinite(s) || (l = "boundary"), ui[l](o)))));
							},
								...
								for (n = l.length - 1; 0 <= n; --n)
									(t = l[n].$filler) &&
										...
										((r = (i = t.el)._view),
											(a = i._children || []),
											(o = t.mapper),
											(s = r.backgroundColor || H.global.defaultColor),
											o && s && a.length && (W.canvas.clipArea(c, e.chartArea), mi(c, a, o, r, s, i._loop), W.canvas.unclipArea(c)));
							},
						},
						...
						H._set("global", {
							...
							legendCallback: function (e) {
								var t,
									...
									r = document.createElement("ul"),
									a = e.data.datasets;
								for (r.setAttribute("class", e.id + "-legend"), t = 0, n = a.length; t < n; t++)
									((i = r.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = a[t].backgroundColor),
										a[t].label && i.appendChild(document.createTextNode(a[t].label));
								return r.outerHTML;
							},
						});
						var _i = $.extend({
									...
									if (((r.font = a.string), c)) {
										...
										(r.textAlign = "left"),
											...
											W.each(e.legendItems, function (e, t) {
												...
												(0 === t || d[d.length - 1] + n + 2 * i.padding > l.width) && ((u += o + i.padding), (d[d.length - (0 < t ? 0 : 1)] = 0)),
							...
							draw: function () {
								...
								if (n.display) {
									var p,
										v = bi(n.rtl, s.left, s.minSize.width),
										m = s.ctx,
										t = Mi(l.fontColor, e.defaultFontColor),
										i = W.options._parseFont(l),
										y = i.size;
									(m.textAlign = v.textAlign("left")), (m.textBaseline = "middle"), (m.lineWidth = 0.5), (m.strokeStyle = t), (m.fillStyle = t), (m.font = i.string);
									var b = wi(l, y),
										x = s.legendHitBoxes,
										M = function (e, t) {
											switch (n.align) {
									...
									W.each(s.legendItems, function (e, t) {
										var n = m.measureText(e.text).width,
											...
											r = p.x,
											a = p.y;
										v.setWidth(s.minSize.width),
											w
												? 0 < t && r + i + l.padding > s.left + s.minSize.width && ((a = p.y += _), p.line++, (r = p.x = s.left + M(f, g[p.line])))
												: 0 < t && a + _ > s.top + s.minSize.height && ((r = p.x = r + s.columnWidths[p.line] + l.padding), p.line++, (a = p.y = s.top + M(u, h[p.line])));
										var o = v.x(r);
										!(function (e, t, n) {
											if (!(isNaN(b) || b <= 0)) {
												m.save();
												...
												if (
													((m.fillStyle = Mi(n.fillStyle, c)),
														(m.lineCap = Mi(n.lineCap, d.borderCapStyle)),
														(m.lineDashOffset = Mi(n.lineDashOffset, d.borderDashOffset)),
														(m.lineJoin = Mi(n.lineJoin, d.borderJoinStyle)),
														(m.lineWidth = i),
														(m.strokeStyle = Mi(n.strokeStyle, c)),
														m.setLineDash && m.setLineDash(Mi(n.lineDash, d.borderDash)),
														l && l.usePointStyle)
												) {
											...
											(x[t].left = v.leftForLtr(o, x[t].width)),
											(function (e, t, n, i) {
												var r = y / 2,
													a = v.xPlus(e, b + r),
													o = t + r;
							...
							_getLegendItemAt: function (e, t) {
								...
								if (e >= this.left && e <= this.right && t >= this.top && t <= this.bottom)
									for (r = this.legendHitBoxes, n = 0; n < r.length; ++n) if (e >= (i = r[n]).left && e <= i.left + i.width && t >= i.top && t <= i.top + i.height) return this.legendItems[n];
								return null;
							},
							handleEvent: function (e) {
								var t,
								...
								(t = this._getLegendItemAt(e.x, e.y)),
									"click" === i
										? t && n.onClick && n.onClick.call(this, e.native, t)
										: (n.onLeave && t !== this._hoveredItem && (this._hoveredItem && n.onLeave.call(this, e.native, this._hoveredItem), (this._hoveredItem = t)), n.onHover && t && n.onHover.call(this, e.native, t));
							},
						});
						function Si(e, t) {
						...
						var Ci = {
							...
							beforeUpdate: function (e) {
								var t = e.options.legend,
									n = e.legend;
								t ? (W.mergeIf(t, H.global.legend), n ? (ft.configure(e, n, t), (n.options = t)) : Si(e, t)) : n && (ft.removeBox(e, n), delete e.legend);
							},
							...
							ki = W.noop;
						H._set("global", { title: { display: !1, fontStyle: "bold", fullWidth: !0, padding: 10, position: "top", text: "", weight: 2e3 } });
						var Ti = $.extend({
							initialize: function (e) {
							...
							fit: function () {
								var e,
									...
									i = this.isHorizontal();
								t.display
									? ((e = (W.isArray(t.text) ? t.text.length : 1) * W.options._parseFont(t).lineHeight + 2 * t.padding), (this.width = n.width = i ? this.maxWidth : e), (this.height = n.height = i ? e : this.maxHeight))
									: (this.width = n.width = this.height = n.height = 0);
							},
							afterFit: ki,
							isHorizontal: function () {
								var e = this.options.position;
							...
							draw: function () {
								...
								if (t.display) {
									var n,
										...
										u = this.bottom,
										h = this.right;
									(e.fillStyle = W.valueOrDefault(t.fontColor, H.global.defaultFontColor)),
										(e.font = a.string),
										this.isHorizontal()
											? ((i = d + (h - d) / 2), (r = c + s), (n = h - d))
											: ((i = "left" === t.position ? d + s : h - s), (r = c + (u - c) / 2), (n = u - c), (l = Math.PI * ("left" === t.position ? -0.5 : 0.5))),
										e.save(),
										e.translate(i, r),
										e.rotate(l),
										(e.textAlign = "center"),
									...
									var f = t.text;
									if (W.isArray(f)) for (var g = 0, p = 0; p < f.length; ++p) e.fillText(f[p], 0, g, n), (g += o);
						...
						var Ei = {},
							...
							Pi = {
								...
								beforeUpdate: function (e) {
									var t = e.options.title,
										n = e.titleBlock;
									t ? (W.mergeIf(t, H.global.title), n ? (ft.configure(e, n, t), (n.options = t)) : Li(e, t)) : n && (ft.removeBox(e, n), delete e.titleBlock);
								},
							};
						function Di(e, t, n) {
							var i;
						...
						for (var zi in ((Ei.filler = Oi),
							(Ei.legend = Ai),
							(Ei.title = Pi),
							((Qt.helpers = W).where = function (e, t) {
							...
							(W.findIndex = Array.prototype.findIndex
								? function (e, t, n) {
							...
							(W.EPSILON = Number.EPSILON || 1e-14),
							(W.splineCurveMonotone = function (e) {
								var t,
									n,
									i,
									r,
								...
								for (t = 0; t < u - 1; ++t)
									(i = d[t]),
										...
										i.model.skip ||
										r.model.skip ||
										(W.almostEquals(i.deltaK, 0, this.EPSILON)
											? (i.mK = r.mK = 0)
											: ((a = i.mK / i.deltaK), (o = r.mK / i.deltaK), (l = Math.pow(a, 2) + Math.pow(o, 2)) <= 9 || ((s = 3 / Math.sqrt(l)), (i.mK = a * s * i.deltaK), (r.mK = o * s * i.deltaK))));
								for (t = 0; t < u; ++t)
									(i = d[t]).model.skip ||
										((n = 0 < t ? d[t - 1] : null),
											(r = t < u - 1 ? d[t + 1] : null),
											n && !n.model.skip && ((c = (i.model.x - n.model.x) / 3), (i.model.controlPointPreviousX = i.model.x - c), (i.model.controlPointPreviousY = i.model.y - c * i.mK)),
											r && !r.model.skip && ((c = (r.model.x - i.model.x) / 3), (i.model.controlPointNextX = i.model.x + c), (i.model.controlPointNextY = i.model.y + c * i.mK)));
							}),
							...
							(W.longestText = function (e, t, n, i) {
								...
								for (o = 0; o < h; o++)
									...
									else if (W.isArray(c)) for (s = 0, l = c.length; s < l; s++) null == (d = c[s]) || W.isArray(d) || (u = W.measureText(e, r, a, u, d));
								var f = a.length / 2;
								if (f > n.length) {
							...
							(W.color = _
								? function (e) {
									return e instanceof CanvasGradient && (e = H.global.defaultColor), _(e);
								}
								: function (e) {
									return console.error("Color.js not found!"), e;
								}),
							(W.getHoverColor = function (e) {
								return e instanceof CanvasPattern || e instanceof CanvasGradient ? e : W.color(e).saturate(0.5).darken(0.1).rgbString();
							}),
							(Qt._adapters = nn),
							(Qt.Animation = K),
							(Qt.animationService = J),
							(Qt.controllers = Ze),
							(Qt.DatasetController = ie),
							(Qt.defaults = H),
							(Qt.Element = $),
							(Qt.elements = we),
							(Qt.Interaction = it),
							...
							(Qt.Ticks = rn),
							(Qt.Tooltip = Gt),
							Qt.helpers.each(ci, function (e, t) {
								Qt.scaleService.registerScaleType(t, e, e._defaults);
							}),
							Ei))
							Ei.hasOwnProperty(zi) && Qt.plugins.register(Ei[zi]);
						Qt.platform.initialize();
						var Hi = Qt;
						return (
							"undefined" != typeof window && (window.Chart = Qt),
							((Qt.Chart = Qt).Legend = Ei.legend._element),
							(Qt.Title = Ei.title._element),
							(Qt.pluginService = Qt.plugins),
							(Qt.PluginBase = Qt.Element.extend({})),
							(Qt.canvasHelpers = Qt.helpers.canvas),
							(Qt.layoutService = Qt.layouts),
							(Qt.LinearScaleBase = Sn),
							Qt.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function (n) {
								Qt[n] = function (e, t) {
									return new Qt(e, Qt.helpers.merge(t || {}, { type: n.charAt(0).toLowerCase() + n.slice(1) }));
								};
							}),
							Hi
						);
			...
			function ($n, Zn, e) {
				...
				(t = this),
					(n = function () {
						...
						function Te(t, n) {
							return function (e) {
								return null != e ? (Ee(this, t, e), h.updateOffset(this, n), this) : Le(this, t);
							};
						}
						function Le(e, t) {
						...
						function Ee(e, t, n) {
							e.isValid() &&
								!isNaN(n) &&
								("FullYear" === t && Se(e.year()) && 1 === e.month() && 29 === e.date() ? e._d["set" + (e._isUTC ? "UTC" : "") + t](n, e.month(), Oe(n, e.month())) : e._d["set" + (e._isUTC ? "UTC" : "") + t](n));
						}
						function Oe(e, t) {
						...
						function Fe(e, t, n, i, r) {
							var a,
								o,
								s = 1 + 7 * (t - 1) + ((7 + n - i) % 7) + Ie(e, i, r);
							return (o = s <= 0 ? _e((a = e - 1)) + s : s > _e(e) ? ((a = e + 1), s - _e(e)) : ((a = e), s)), { year: a, dayOfYear: o };
						}
						function We(e, t, n) {
							var i,
								r,
						...
						function st(e) {
							var t = null;
							if (!rt[e] && void 0 !== Zn && Zn && Zn.exports)
								try {
						...
						function ut(e) {
							...
							return (
								...
								((t =
									n[pe] < 0 || 11 < n[pe]
										? pe
										: n[ve] < 1 || n[ve] > Oe(n[ge], n[pe])
											? ve
											: n[me] < 0 || 24 < n[me] || (24 === n[me] && (0 !== n[ye] || 0 !== n[be] || 0 !== n[xe]))
												? me
												: n[ye] < 0 || 59 < n[ye]
													? ye
													: n[be] < 0 || 59 < n[be]
														...
														: n[xe] < 0 || 999 < n[xe]
															? xe
															: -1),
									g(e)._overflowDayOfYear && (t < ge || ve < t) && (t = ve),
									g(e)._overflowWeeks && -1 === t && (t = Me),
									g(e)._overflowWeekday && -1 === t && (t = we),
									(g(e).overflow = t)),
								e
							);
						}
						...
						function ft(e) {
							...
							if (!e._d) {
								for (
									...
									null != e._dayOfYear &&
									((a = ht(e._a[ge], i[ge])),
										(e._dayOfYear > _e(a) || 0 === e._dayOfYear) && (g(e)._overflowDayOfYear = !0),
								...
								24 === e._a[me] && 0 === e._a[ye] && 0 === e._a[be] && 0 === e._a[xe] && ((e._nextDay = !0), (e._a[me] = 0)),
									(e._d = (e._useUTC
										? Ne
									...
									e._w && void 0 !== e._w.d && e._w.d !== r && (g(e).weekdayMismatch = !0);
							}
						}
							...
							if (e._f !== h.ISO_8601)
								if (e._f !== h.RFC_2822) {
									...
									var t,
										...
										d = c.length,
										u = 0;
									for (i = Y(e._f, e._locale).match(B) || [], t = 0; t < i.length; t++)
										(r = i[t]),
											(n = (c.match(ce(r, e)) || [])[0]) && (0 < (a = c.substr(0, c.indexOf(n))).length && g(e).unusedInput.push(a), (c = c.slice(c.indexOf(n) + n.length)), (u += n.length)),
											F[r] ? (n ? (g(e).empty = !1) : g(e).unusedTokens.push(r), (o = r), (l = e), null != (s = n) && f(ue, o) && ue[o](s, l._a, l, o)) : e._strict && !n && g(e).unusedTokens.push(r);
									(g(e).charsLeftOver = d - u),
										0 < c.length && g(e).unusedInput.push(c),
										e._a[me] <= 12 && !0 === g(e).bigHour && 0 < e._a[me] && (g(e).bigHour = void 0),
													...
													? (function (e) {
														...
														for (r = 0; r < e._f.length; r++)
															(a = 0),
																...
																(t._f = e._f[r]),
																Ct(t),
																p(t) && ((a += g(t).charsLeftOver), (a += 10 * g(t).unusedTokens.length), (g(t).score = a), (null == i || a < i) && ((i = a), (n = t)));
														d(e, n || t);
													})(e)
													: n
														? Ct(e)
						...
						(h.createFromInputFallback = n(
							...
							(h.ISO_8601 = function () { }),
							(h.RFC_2822 = function () { });
						var Et = n("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function () {
						...
						function Dt(e) {
							...
							(this._isValid = (function (e) {
								for (var t in e) if (-1 === Ce.call(Pt, t) || (null != e[t] && isNaN(e[t]))) return !1;
								...
								(this._milliseconds = +d + 1e3 * c + 6e4 * l + 1e3 * s * 60 * 60),
								(this._days = +o + 7 * a),
							...
							return (
								Vt(e)
									...
									: l(e)
										...
										: (o = Wt.exec(e))
											? ((n = "-" === o[1] ? -1 : 1), (a = { y: 0, d: w(o[ve]) * n, h: w(o[me]) * n, m: w(o[ye]) * n, s: w(o[be]) * n, ms: w(Rt(1e3 * o[xe])) * n }))
											: (o = jt.exec(e))
												? ((n = "-" === o[1] ? -1 : 1), (a = { y: Gt(o[2], n), M: Gt(o[3], n), w: Gt(o[4], n), d: Gt(o[5], n), h: Gt(o[6], n), m: Gt(o[7], n), s: Gt(o[8], n) }))
												: null == a
													? (a = {})
													: "object" == typeof a &&
													("from" in a || "to" in a) &&
													((r = (function (e, t) {
														...
														(a.M = r.months)),
								(i = new Dt(a)),
								Vt(e) && f(e, "_locale") && (i._locale = e._locale),
								i
							);
						}
						function Gt(e, t) {
						...
						function qt(i, r) {
							return function (e, t) {
								...
								return (
									null === t ||
									isNaN(+t) ||
									(T(r, "moment()." + r + "(period, number) is deprecated. Please use moment()." + r + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
										(n = e),
										(e = t),
										(t = n)),
									Xt(this, Yt((e = "string" == typeof e ? +e : e), t), i),
									this
								);
							};
						}
						function Xt(e, t, n, i) {
							var r = t._milliseconds,
								a = Rt(t._days),
								o = Rt(t._months);
							e.isValid() && ((i = null == i || i), o && Ve(e, Le(e, "Month") + o * n), a && Ee(e, "Date", Le(e, "Date") + a * n), r && e._d.setTime(e._d.valueOf() + r * n), i && h.updateOffset(e, a || o));
						}
						(Yt.fn = Dt.prototype),
							(Yt.invalid = function () {
								return Yt(NaN);
						...
						(gn.add = $t),
							...
							(gn.from = function (e, t) {
								return this.isValid() && ((x(e) && e.isValid()) || Lt(e).isValid()) ? Yt({ to: this, from: e }).locale(this.locale()).humanize(!t) : this.localeData().invalidDate();
							}),
							(gn.fromNow = function (e) {
								return this.from(Lt(), e);
							}),
							(gn.to = function (e, t) {
								return this.isValid() && ((x(e) && e.isValid()) || Lt(e).isValid()) ? Yt({ from: this, to: e }).locale(this.locale()).humanize(!t) : this.localeData().invalidDate();
							}),
							(gn.toNow = function (e) {
								return this.to(Lt(), e);
							}),
							...
							(gn.isSame = function (e, t) {
								...
								return (
									...
									("millisecond" === (t = D(t) || "millisecond") ? this.valueOf() === i.valueOf() : ((n = i.valueOf()), this.clone().startOf(t).valueOf() <= n && n <= this.clone().endOf(t).valueOf()))
								);
							}),
							...
							(gn.utcOffset = function (e, t, n) {
								...
								return (
									...
									(this._isUTC = !0),
									null != i && this.add(i, "m"),
									r !== e && (!t || this._changeInProgress ? Xt(this, Yt(e - r, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), h.updateOffset(this, !0), (this._changeInProgress = null))),
									this
								);
							}),
							(gn.utc = function (e) {
							...
							(gn.dates = n("dates accessor is deprecated. Use date instead.", ln)),
							(gn.months = n("months accessor is deprecated. Use month instead", Re)),
							(gn.years = n("years accessor is deprecated. Use year instead", ke)),
						...
						(vn.calendar = function (e, t, n) {
							...
							(vn.months = function (e, t) {
								return e ? (o(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || Ae).test(t) ? "format" : "standalone"][e.month()]) : o(this._months) ? this._months : this._months.standalone;
							}),
							(vn.monthsShort = function (e, t) {
								return e ? (o(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[Ae.test(t) ? "format" : "standalone"][e.month()]) : o(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone;
							}),
							...
							(vn.monthsRegex = function (e) {
								return this._monthsParseExact
									? (f(this, "_monthsRegex") || Be.call(this), e ? this._monthsStrictRegex : this._monthsRegex)
									: (f(this, "_monthsRegex") || (this._monthsRegex = He), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
							}),
							(vn.monthsShortRegex = function (e) {
								return this._monthsParseExact
									? (f(this, "_monthsRegex") || Be.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex)
									: (f(this, "_monthsShortRegex") || (this._monthsShortRegex = ze), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
							}),
							(vn.week = function (e) {
							...
							(vn.weekdaysRegex = function (e) {
								return this._weekdaysParseExact
									? (f(this, "_weekdaysRegex") || Ke.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex)
									: (f(this, "_weekdaysRegex") || (this._weekdaysRegex = Xe), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
							}),
							(vn.weekdaysShortRegex = function (e) {
								return this._weekdaysParseExact
									? (f(this, "_weekdaysRegex") || Ke.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
									: (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $e), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
							}),
							(vn.weekdaysMinRegex = function (e) {
								return this._weekdaysParseExact
									? (f(this, "_weekdaysRegex") || Ke.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
									: (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Ze), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
							}),
							(vn.isPM = function (e) {
							...
							(h.lang = n("moment.lang is deprecated. Use moment.locale instead.", lt)),
							(h.langData = n("moment.langData is deprecated. Use moment.localeData instead.", dt));
						var xn = Math.abs;
						function Mn(e, t, n, i) {
							var r = Yt(t, n);
						...
						return (
							...
							(Xn.as = function (e) {
								...
								if ("month" === (e = D(e)) || "quarter" === e || "year" === e)
									switch (((t = this._days + i / 864e5), (n = this._months + _n(t)), e)) {
										case "month":
											return n;
										case "quarter":
											return n / 3;
							...
							(Xn._bubble = function () {
								var e,
									...
									l = this._data;
								return (
									(0 <= a && 0 <= o && 0 <= s) || (a <= 0 && o <= 0 && s <= 0) || ((a += 864e5 * wn(Sn(s) + o)), (s = o = 0)),
							...
							(Xn.locale = Jt),
							(Xn.localeData = en),
							(Xn.toIsoString = n("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", qn)),
							(Xn.lang = Qt),
							W("X", 0, 0, "unix"),
							W("x", 0, 0, "valueOf"),
							le("x", ie),
							...
							(h.updateLocale = function (e, t) {
								if (null != t) {
									var n,
										i,
										r = it;
									null != (i = st(e)) && (r = i._config), ((n = new O((t = E(r, t)))).parentLocale = rt[e]), (rt[e] = n), lt(e);
					...
					(e = this),
						(t = function () {
							...
							var h,
								...
								B = H("native-function-to-string", Function.toString),
								N = y.WeakMap,
								I = "function" == typeof N && /native code/.test(B.call(N)),
								F = 0,
								W = Math.random(),
								j = H("keys"),
								Y = {},
							...
							function te(c) {
								return function (e, t, n) {
									...
									if (c && t != t) {
										for (; l < s;) if ((i = o[l++]) != i) return !0;
									} else for (; l < s; l++) if ((c || l in o) && o[l] === t) return c || l || 0;
									return !c && -1;
								};
							}
							function ne(e, t) {
							...
							function re(e, t) {
								var n = Ee[Le(e)];
								return n == Ae || (n != Oe && ("function" == typeof t ? v(t) : !!t));
							}
							function ae(e, t) {
								var n,
									i,
							...
							function ce(e) {
								return He[e] || (He[e] = (Re && ze[e]) || (Re ? ze : s)("Symbol." + e));
							}
							function de(e, t) {
								var n;
								return Ve(e) && ("function" != typeof (n = e.constructor) || (n !== Array && !Ve(n.prototype)) ? m(n) && null === (n = n[Be]) && (n = void 0) : (n = void 0)), new (void 0 === n ? Array : n)(0 === t ? 0 : t);
							}
							function ue(f) {
								var g = 1 == f,
									p = 2 == f,
									...
									H("inspectSource", function (e) {
										...
										(e.exports = function (e, t, n, i) {
											var r = !!i && !!i.unsafe,
												a = !!i && !!i.enumerable,
												o = !!i && !!i.noTargetGet;
											"function" == typeof n && ("string" != typeof t || c(n, "name") || z(n, "name", t), (s(n).source = l.join("string" == typeof t ? t : ""))),
												e !== y ? (r ? !o && e[t] && (a = !0) : delete e[t], a ? (e[t] = n) : z(e, t, n)) : a ? (e[t] = n) : u(t, n);
							...
							var Ke =
								...
								tt = function () {
									var e,
										t = a("iframe"),
										n = we.length;
									for (t.style.display = "none", Qe.appendChild(t), t.src = String("javascript:"), (e = t.contentWindow.document).open(), e.write("<script>document.F=Object</script>"), e.close(), tt = e.F; n--;)
										delete tt.prototype[we[n]];
									return tt();
								},
								nt =
									Object.create ||
							...
							var ot,
								...
								gt = ce("iterator"),
								pt = !1;
							[].keys && ("next" in (lt = [].keys()) ? (st = ft(ft(lt))) !== Object.prototype && (ot = st) : (pt = !0)),
								null == ot && (ot = {}),
								c(ot, gt) ||
								z(ot, gt, function () {
									return this;
							...
							function vt(e, t, n) {
								e && !c((e = n ? e : e.prototype), wt) && Mt(e, wt, { configurable: !0, value: t });
							}
							function mt() {
								return this;
							}
							...
							function bt(e, t, n, i, r, a, o) {
								...
								if (
									(b && ((u = ft(b.call(new e()))), Ct !== Object.prototype && u.next && (ft(u) !== Ct && (St ? St(u, Ct) : "function" != typeof u[Tt] && z(u, Tt, yt)), vt(u, g, !0))),
										"values" == r &&
										m &&
										"values" !== m.name &&
										((p = !0),
									...
									if (((h = { values: d("values"), keys: a ? y : d("keys"), entries: d("entries") }), o)) for (f in h) (!kt && !p && f in v) || ge(v, f, h[f]);
							...
							var xt = { IteratorPrototype: ot, BUGGY_SAFARI_ITERATORS: pt },
								...
								Tt = ce("iterator"),
								Lt = fe.set,
								Et = fe.getterFor("Array Iterator"),
								Ot = bt(
									Array,
									"Array",
									function (e, t) {
										Lt(this, { type: "Array Iterator", target: d(e), index: 0, kind: t });
									},
									function () {
										var e = Et(this),
											t = e.target,
									...
									!At ||
										v(function () {
											...
											return (
												...
												7 != At({}, e)[n] || "abcdefghijklmnopqrst" != Ke(At({}, t)).join("")
											);
										})
										? function (e, t) {
							...
							var Ht =
								"[object z]" !== String(zt)
									...
									: zt.toString,
								Bt = Object.prototype;
							Ht !== Bt.toString && ge(Bt, "toString", Ht, { unsafe: !0 });
							function Nt(n) {
								return function (e) {
									var t = String(l(e));
									...
									(e.exports = function (e, t, n, i, r) {
										...
										if (r) a = e;
											...
											if (void 0 !== (u = o) && (ct.Array === u || on[an] === u)) {
												for (s = 0, l = ee(e.length); s < l; s++) if ((c = i ? h(S((d = e[s]))[0], d[1]) : h(e[s])) && c instanceof f) return c;
												return new f(!1);
											}
											a = o.call(e);
										}
										for (; !(d = a.next()).done;) if ((c = en(a, h, d.value, i)) && c instanceof f) return c;
										return new f(!1);
									}).stop = function (e) {
										return new f(!0, e);
									};
									...
									g ||
										(((d = e(function (e, t) {
											...
											var n,
												...
												r,
												a,
												o = ((n = new c()), (i = d), St && "function" == typeof (r = e.constructor) && r !== i && m((a = r.prototype)) && a !== i.prototype && St(n, a), n);
											return null != t && ln(t, o[u], o, l), o;
										})).prototype = r).constructor = d),
										(f || p) && (n("delete"), n("has"), l && n("get")),
										(p || h) && n(u),
							...
							var _n = {
								getConstructor: function (e, n, i, r) {
									...
									var o = e(function (e, t) {
										tn(e, o, n), mn(e, { type: n, id: Mn++, frozen: void 0 }), null != t && ln(t, e[r], e, i);
									}),
										s = yn(n);
									return (
										Qt(o.prototype, {
							...
							function qn(e) {
								...
								e = e.replace(Rn, "");
								var i = Hn.test(e);
								return i || Bn.test(e) ? Nn(e.slice(2), i ? 2 : 8) : zn.test(e) ? Dn : +e;
							}
							function Xn(e, t, n) {
								var i = !0,
									r = !0;
								...
								return (
									Un(n) && ((i = "leading" in n ? !!n.leading : i), (r = "trailing" in n ? !!n.trailing : r)),
									(function (i, r, e) {
										var a,
											o,
											n,
										...
										return (
											(r = qn(r) || 0),
											Un(e) && ((u = !!e.leading), (n = (h = "maxWait" in e) ? Yn(qn(e.maxWait) || 0, r) : n), (t = "trailing" in e ? !!e.trailing : t)),
											(m.cancel = function () {
												void 0 !== l && clearTimeout(l), (a = c = o = l = void (d = 0));
											}),
											(m.flush = function () {
												return void 0 === l ? s : v(An());
											}),
											m
										);
							...
							function ci(i, r, e) {
								...
								return (
									(r = li(r) || 0),
									si(e) && ((u = !!e.leading), (n = (h = "maxWait" in e) ? ai(li(e.maxWait) || 0, r) : n), (t = "trailing" in e ? !!e.trailing : t)),
									(m.cancel = function () {
										void 0 !== l && clearTimeout(l), (a = c = o = l = void (d = 0));
									}),
									(m.flush = function () {
							...
							function Hi(r, a) {
								...
								return (o.cache = new (Hi.Cache || Di)()), o;
							}
							function Bi(e) {
								var t = typeof e;
								return !!e && ("object" == t || "function" == t);
							...
							(Ai.prototype.clear = function () {
								...
								(Ai.prototype.has = function (e) {
									var t = this.__data__;
									return Oi ? void 0 !== t[e] : Ci.call(t, e);
								}),
								(Ai.prototype.set = function (e, t) {
									return (this.__data__[e] = Oi && void 0 === t ? hi : t), this;
								}),
								...
								(Di.prototype.clear = function () {
									this.__data__ = { hash: new Ai(), map: new (Ei || Pi)(), string: new Ai() };
								}),
							...
							var Ii = Hi,
								...
								qi =
									((Zi.prototype.addObserver = function (e) {
							...
							function Zi() {
								...
								(this.connected_ = !1),
									...
									(this.refresh = ((i = this.refresh.bind(this)), (o = a = !(r = 20)), (s = 0), n));
							}
							function Ki(e) {
							...
							function er(e) {
								return Wi
									? Qi(e)
										? tr(0, 0, (t = e.getBBox()).width, t.height)
										: (function (e) {
											var t = e.clientWidth,
												n = e.clientHeight;
											if (!t && !n) return $i;
											var i = Xi(e).getComputedStyle(e),
												...
												l = Ki(i.height);
											if (
												("border-box" === i.boxSizing && (Math.round(s + a) !== t && (s -= Ji(i, "left", "right") + a), Math.round(l + o) !== n && (l -= Ji(i, "top", "bottom") + o)),
								...
								var n,
									...
									c =
										((i = (n = t).x),
											...
											Ni(l, { x: i, y: r, width: a, height: o, top: r, right: i + a, bottom: o + r, left: i }),
											l);
							...
							var rr =
								((lr.prototype.isActive = function () {
									...
									lr),
								ar =
									((sr.prototype.observe = function (e) {
										if (!arguments.length) throw new TypeError("1 argument required, but only 0 present.");
							...
							var fr = (function () {
									...
									(this.onScroll = function () {
										...
										(this.onPointerEvent = function (e) {
											...
											(s.axis.x.track.rect = s.axis.x.track.el.getBoundingClientRect()),
												...
												(s.axis.y.isOverflowing || s.axis.y.forceVisible) && (n = s.isWithinBounds(s.axis.y.track.rect)),
												(t || n) &&
												(e.preventDefault(),
													e.stopPropagation(),
													"mousedown" === e.type &&
													(t && ((s.axis.x.scrollbar.rect = s.axis.x.scrollbar.el.getBoundingClientRect()), s.isWithinBounds(s.axis.x.scrollbar.rect) ? s.onDragStart(e, "x") : s.onTrackClick(e, "x")),
														n && ((s.axis.y.scrollbar.rect = s.axis.y.scrollbar.el.getBoundingClientRect()), s.isWithinBounds(s.axis.y.scrollbar.rect) ? s.onDragStart(e, "y") : s.onTrackClick(e, "y"))));
										}),
										(this.drag = function (e) {
											...
											"x" === s.draggedAxis && ((o = s.isRtl && l.getRtlHelpers().isRtlScrollbarInverted ? o - (n + i.size) : o), (o = s.isRtl && l.getRtlHelpers().isRtlScrollingInverted ? -o : o)),
										...
										((this.recalculate = Xn(this.recalculate.bind(this), 64)),
											(this.onMouseMove = Xn(this.onMouseMove.bind(this), 64)),
											(this.hideScrollbars = ci(this.hideScrollbars.bind(this), this.options.timeout)),
											(this.onWindowResize = ci(this.onWindowResize.bind(this), 64, { leading: !0 })),
											(l.getRtlHelpers = Ii(l.getRtlHelpers)),
											this.init());
								}
								...
								return (
									...
									(e.recalculate = function () {
										...
										(this.axis.x.isOverflowing = this.axis.x.isOverflowing && i - d < s),
											(this.axis.y.isOverflowing = this.axis.y.isOverflowing && l - c < o),
									...
									(e.positionScrollbar = function (e) {
										if ((void 0 === e && (e = "y"), this.axis[e].isOverflowing)) {
											var t = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
												...
												s = ~~((n - r.size) * o);
											(s = "x" === e && this.isRtl && l.getRtlHelpers().isRtlScrollbarInverted ? s + (n - r.size) : s),
												(r.el.style.transform = "x" === e ? "translate3d(" + s + "px, 0, 0)" : "translate3d(0, " + s + "px, 0)");
										}
									}),
									...
									(e.onDragStart = function (e, t) {
										...
										(this.axis[t].dragOffset = i - n.rect[this.axis[t].offsetAttr]),
											(this.draggedAxis = t),
									...
									(e.onTrackClick = function (e, i) {
										...
										!(function e() {
											var t, n;
											-1 == o
												? s < a && ((a -= 40), r.contentWrapperEl.scrollTo((((t = {})[r.axis[i].offsetAttr] = a), t)), window.requestAnimationFrame(e))
												: a < s && ((a += 40), r.contentWrapperEl.scrollTo((((n = {})[r.axis[i].offsetAttr] = a), n)), window.requestAnimationFrame(e));
										})();
									}),
							...
							(Cr || kr) &&
								(Sr = function (e) {
									...
									return (
										...
										Cr && (t = this.lastIndex),
										(i = wr.call(this, e)),
										Cr && i && (this.lastIndex = this.global ? i.index + i[0].length : t),
										kr &&
										i &&
										1 < i.length &&
								...
								if (!a || !o || ("replace" === n && !Pr) || ("split" === n && !Dr)) {
									var s = /./[r],
										l = t(r, ""[n], function (e, t, n, i, r) {
											return t.exec === Tr ? (a && !r ? { done: !0, value: s.call(t, n, i) } : { done: !0, value: e.call(n, t, i) }) : { done: !1 };
										}),
										c = l[0],
										d = l[1];
									ge(String.prototype, n, c),
										ge(
											RegExp.prototype,
											r,
											2 == e
							...
							Lr("match", 1, function (i, c, d) {
								return [
									...
									function (e) {
										...
										var n = S(e),
											i = String(this);
										if (!n.global) return Or(n, i);
										for (var r, a = n.unicode, o = [], s = (n.lastIndex = 0); null !== (r = Or(n, i));) {
											var l = String(r[0]);
											"" === (o[s] = l) && (n.lastIndex = Er(i, ee(n.lastIndex), a)), s++;
										}
										return 0 === s ? null : o;
									},
								];
								...
								return [
									...
									function (e, t) {
										...
										for (var l = []; ;) {
											...
											if (null === c) break;
											if ((l.push(c), !o)) break;
											"" === String(c[0]) && (i.lastIndex = Er(r, ee(i.lastIndex), s));
										}
							...
							return (
								(fr.initDOMLoadedElements = function () {
								...
								(fr.initHtmlApi = function () {
									(this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this)),
										"undefined" != typeof MutationObserver && ((this.globalObserver = new MutationObserver(fr.handleMutations)), this.globalObserver.observe(document, { childList: !0, subtree: !0 })),
		...
		17: [
			function (e, t, n) {
				...
				Object.defineProperty(n, "__esModule", { value: !0 }),
					(n.extend = function () {
						for (var e, t, n, i = arguments[0] || {}, r = 1, a = arguments.length; r < a; r++) if (null !== (e = arguments[r])) for (t in e) (n = e[t]), i !== n && void 0 !== n && (i[t] = n);
						return i;
					});
			},
			{},
				...
				Object.defineProperty(n, "__esModule", { value: !0 }),
					(n.has3DTransforms = function (e) {
						...
						return (
							...
							i.fake ? (0, c.resetFakeBody)(i, r) : a.remove(),
			...
			function (e, t, n) {
				...
				Object.defineProperty(n, "__esModule", { value: !0 }),
					(n.removeAttrs = function (e, t) {
						...
						for (var n = (t = t instanceof Array ? t : [t]).length, i = e.length; i--;) for (var r = n; r--;) e[i].removeAttribute(t[r]);
					});
		...
		47: [
			function (e, t, n) {
				...
				var wi = e("./helpers/raf.js"),
					...
					Ei = e("./helpers/percentageLayout.js"),
					Oi = e("./helpers/mediaquerySupport.js"),
					Ai = e("./helpers/createStyleSheet.js"),
					...
					Hi = e("./helpers/forEach.js"),
					Bi = e("./helpers/hasClass.js"),
				...
				n.tns = function e(E) {
					...
					var m = t.tC ? (0, Ci.checkStorageValue)(t.tC) : (0, ki.setLocalStorage)(t, "tC", (0, Li.calc)(), n),
						y = t.tPL ? (0, Ci.checkStorageValue)(t.tPL) : (0, ki.setLocalStorage)(t, "tPL", (0, Ei.percentageLayout)(), n),
						A = t.tMQ ? (0, Ci.checkStorageValue)(t.tMQ) : (0, ki.setLocalStorage)(t, "tMQ", (0, Oi.mediaquerySupport)(), n),
					...
					if (
						(f.forEach(function (e) {
							if ("string" == typeof E[e]) {
								var t = E[e],
									n = O.querySelector(t);
								if (((g[e] = t), !n || !n.nodeName)) return void (h && console.warn("Can't find", E[e]));
								E[e] = n;
							}
						}),
						...
						var P = E.responsive,
							...
							V = "carousel" === E.mode;
						if (P) {
							0 in P && ((E = (0, Si.extend)(E, P[0])), delete P[0]);
							var p = {};
							for (var M in P) {
								var w = P[M];
						...
						var L,
							...
							xe = (0, Ai.createStyleSheet)(),
							Me = E.lazyload,
							we = (E.lazyloadSelector, []),
							_e = le
								? ((X = (function () {
									{
							...
							Ae = K
								...
								: Z
									? function () {
										for (var e = Se; e--;) if (L[e] >= -ke) return e;
									}
									: function () {
							...
							Ve = ($t(), 0),
							Re = Z ? null : Ae(),
							ze = E.preventActionWhenRunning,
							He = E.swipeAngle,
							Be = !He || "?",
							Ne = !1,
							Ie = E.onInit,
							Fe = new er.Events(),
							We = " tns-slider tns-" + E.mode,
							...
							Je = {
								visibilitychange: function () {
									O.hidden ? Pt && (ri(), (Rt = !0)) : Rt && (ii(), (Rt = !1));
								},
							},
							Qe = {
								keydown: function (e) {
						...
						if (nt)
							var ht,
								ft,
								gt = E.controlsContainer,
								pt = E.controlsContainer ? E.controlsContainer.outerHTML : "",
								vt = E.prevButton,
								mt = E.nextButton,
								yt = E.prevButton ? E.prevButton.outerHTML : "",
								bt = E.nextButton ? E.nextButton.outerHTML : "";
						if (it)
							var xt,
								Mt = E.navContainer,
								wt = E.navContainer ? E.navContainer.outerHTML : "",
								_t = Z ? j : bi(),
								St = 0,
								Ct = -1,
								kt = Jt(),
						...
						if (at)
							var At,
								...
								Vt,
								Rt,
								zt = "forward" === E.autoplayDirection ? 1 : -1,
								Ht = E.autoplayButton,
								Bt = E.autoplayButton ? E.autoplayButton.outerHTML : "",
						...
						Z || Xt(Ye || qe),
							o && ((Le = o), (Ee = "translate"), (Oe = s ? ((Ee += N ? "3d(" : "3d(0px, "), N ? ", 0px, 0px)" : ", 0px)") : ((Ee += N ? "X(" : "Y("), ")"))),
							V && (F.className = F.className.replace("tns-vpfix", "")),
							(function () {
								nn("gutter");
								...
								(We += " tns-" + E.axis), (F.className += We), V ? (((S = O.createElement("div")).id = je + "-mw"), (S.className = "tns-ovh"), C.appendChild(S), S.appendChild(I)) : C.appendChild(I);
								if (ce) {
								...
								if (
									(k.insertBefore(C, F),
										I.appendChild(F),
										(0, Hi.forEach)(W, function (e, t) {
											(0, Ni.addClass)(e, "tns-item"), e.id || (e.id = je + "-item" + t), !V && H && (0, Ni.addClass)(e, H), (0, ji.setAttrs)(e, { "aria-hidden": "true", tabindex: "-1" });
										}),
										_e)
								) {
									for (var e = O.createDocumentFragment(), t = O.createDocumentFragment(), n = _e; n--;) {
										var i = n % j,
											r = W[i].cloneNode(!0);
							...
							(function () {
								if (!V)
									for (var e = Pe, t = Pe + Math.min(j, ne); e < t; e++) {
										var n = W[e];
										(n.style.left = (100 * (e - Pe)) / ne + "%"), (0, Ni.addClass)(n, R), (0, Ii.removeClass)(n, H);
									}
								N &&
									(y || Z
										? ((0, Pi.addCSSRule)(xe, "#" + je + " > .tns-item", "font-size:" + v.getComputedStyle(W[0]).fontSize + ";", (0, Vi.getCssRulesLength)(xe)),
											(0, Pi.addCSSRule)(xe, "#" + je, "font-size:0;", (0, Vi.getCssRulesLength)(xe)))
										: V &&
										(0, Hi.forEach)(W, function (e, t) {
								...
								if (A) {
									if (b) {
										var i = S && E.autoHeight ? dn(E.speed) : "";
										(0, Pi.addCSSRule)(xe, "#" + je + "-mw", i, (0, Vi.getCssRulesLength)(xe));
									}
									(i = an(E.edgePadding, E.gutter, E.fixedWidth, E.speed, E.autoHeight)),
										(0, Pi.addCSSRule)(xe, "#" + je + "-iw", i, (0, Vi.getCssRulesLength)(xe)),
										V && ((i = N && !Z ? "width:" + on(E.fixedWidth, E.gutter, E.items) + ";" : ""), b && (i += dn(oe)), (0, Pi.addCSSRule)(xe, "#" + je, i, (0, Vi.getCssRulesLength)(xe))),
										(i = N && !Z ? sn(E.fixedWidth, E.gutter, E.items) : ""),
										E.gutter && (i += ln(E.gutter)),
										V || (b && (i += dn(oe)), x && (i += un(oe))),
										i && (0, Pi.addCSSRule)(xe, "#" + je + " > .tns-item", i, (0, Vi.getCssRulesLength)(xe));
								} else {
								...
								if (P && A)
									for (var r in P) {
										...
										var a = P[r],
											...
											g = rn("autoHeight", r),
											p = rn("gutter", r);
										b && S && rn("autoHeight", r) && "speed" in a && (o = "#" + je + "-mw{" + dn(h) + "}"),
											("edgePadding" in a || "gutter" in a) && (s = "#" + je + "-iw{" + an(f, p, u, h, g) + "}"),
											V && N && !Z && ("fixedWidth" in a || "items" in a || (K && "gutter" in a)) && (l = "width:" + on(u, p, d) + ";"),
											b && "speed" in a && (l += dn(h)),
											(l = l && "#" + je + "{" + l + "}"),
											("fixedWidth" in a || (K && "gutter" in a) || (!V && "items" in a)) && (c += sn(u, p, d)),
											"gutter" in a && (c += ln(p)),
											!V && "speed" in a && (b && (c += dn(h)), x && (c += un(h))),
											(i = o + s + l + (c = c && "#" + je + " > .tns-item{" + c + "}")) && xe.insertRule("@media (min-width: " + r / 16 + "em) {" + i + "}", xe.cssRules.length);
									}
							})(),
							hn();
						var Ut = le
							? V
								...
								: function () {
									if (Re < Pe) for (; Ve + j <= Pe;) Pe -= j;
									else if (Pe < Ve) for (; Pe <= Re - j;) Pe += j;
								}
							: function () {
							...
							qt = V
								? function () {
									Gn(F, ""), b || !oe ? (Zn(), (oe && (0, Xi.isVisible)(F)) || ei()) : (0, tr.jsTransform)(F, Le, Ee, Oe, Xn(), oe, ei), N || yi();
								}
								: function () {
									we = [];
									var e = {};
									(e[d] = e[u] = ei), (0, Qi.removeEvents)(W[De], e), (0, Ji.addEvents)(W[Pe], e), Kn(De, R, z, !0), Kn(Pe, H, R), (d && u && oe && (0, Xi.isVisible)(F)) || ei();
								};
						return {
							version: "2.9.2",
							getInfo: Mi,
							...
							destroy: function () {
								if (
									((xe.disabled = !0),
										xe.ownerNode && xe.ownerNode.remove(),
										(0, Qi.removeEvents)(v, { resize: mn }),
										ae && (0, Qi.removeEvents)(O, Qe),
										gt && (0, Qi.removeEvents)(gt, $e),
										Mt && (0, Qi.removeEvents)(Mt, Ze),
										(0, Qi.removeEvents)(F, Ke),
										(0, Qi.removeEvents)(F, Je),
										Ht && (0, Qi.removeEvents)(Ht, { click: li }),
										pe && clearInterval(At),
										V && d)
								) {
									var e = {};
								...
								var a = [T, pt, yt, bt, wt, Bt];
								for (var t in (f.forEach(function (e, t) {
									var n = "container" === e ? C : E[e];
									if ("object" === nr(n)) {
										var i = !!n.previousElementSibling && n.previousElementSibling,
											r = n.parentNode;
										(n.outerHTML = a[t]), (E[e] = i ? i.nextElementSibling : r.firstElementChild);
									}
								}),
									(f = R = z = _ = H = N = C = I = F = k = T = W = j = B = Y = Z = K = J = Q = ee = ne = ie = re = ae = oe = se = le = ce = xe = Me = L = we = _e = Se = Ce = ke = Te = Le = Ee = Oe = Ae = Pe = De = Ve = Re = He = Be = Ne = Ie = Fe = We = je = Ye = Ge = Ue = qe = Xe = $e = Ze = Ke = Je = Qe = et = tt = nt = it = rt = at = ot = st = lt = ct = dt = U = de = ue = gt = pt = vt = mt = ht = ft = he = Mt = wt = xt = _t = St = Ct = kt = Tt = Lt = Et = Ot = pe = ve = zt = me = ye = Ht = Bt = be = Nt = At = Pt = Dt = Vt = Rt = Wt = jt = It = Yt = Ft = Gt = fe = ge = null),
									this))
									"rebuild" !== t && (this[t] = null);
								G = !1;
							},
							rebuild: function () {
								return e((0, Si.extend)(E, g));
							},
						};
					}
					function Xt(e) {
					...
					function Qt() {
						return v.innerWidth || O.documentElement.clientWidth || O.body.clientWidth;
					}
					function en(e) {
					...
					function rn(e, t) {
						...
						var n = E[e];
						if (P) for (var i in P) t >= parseInt(i) && e in P[i] && (n = P[i][e]);
					...
					function hn() {
						if (nn("autoHeight") || Z || !N) {
							...
							(0, Hi.forEach)(e, function (e) {
								var t = e.src;
								t && t.indexOf("data:image") < 0 ? ((0, Ji.addEvents)(e, dt), (e.src = ""), (e.src = t), (0, Ni.addClass)(e, "loading")) : Me || En(e);
							}),
								(0, wi.raf)(function () {
								...
								!Z && N && (e = An(Pe, Math.min(Pe + ne - 1, Se - 1))),
								Me
									? fn()
									: (0, wi.raf)(function () {
					...
					function fn() {
						if (Z) {
							var t = le ? Pe : j - 1;
							!(function e() {
								W[t - 1].getBoundingClientRect().right.toFixed(2) === W[t].getBoundingClientRect().left.toFixed(2)
									? gn()
									: setTimeout(function () {
										e();
									}, 16);
					...
					function gn() {
						(N && !Z) || (Bn(), Z ? ((ke = qn()), Ue && (qe = bn()), (Re = Ae()), Xt(Ye || qe)) : yi()), V && $n(), pn(), vn();
					}
					function pn() {
						if (
							(Nn(),
								C.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + kn() + "</span>  of " + j + "</div>"),
								(q = C.querySelector(".tns-liveregion .current")),
								at)
						) {
							var e = pe ? "stop" : "start";
							Ht
								? (0, ji.setAttrs)(Ht, { "data-action": e })
								: E.autoplayButtonOutput && (C.insertAdjacentHTML(en(E.autoplayPosition), '<button data-action="' + e + '">' + Nt[0] + e + Nt[1] + me[0] + "</button>"), (Ht = C.querySelector("[data-action]"))),
								Ht && (0, Ji.addEvents)(Ht, { click: li }),
								pe && (oi(), ye && (0, Ji.addEvents)(F, Ke), be && (0, Ji.addEvents)(F, Je));
						}
						if (it) {
							if (Mt)
								(0, ji.setAttrs)(Mt, { "aria-label": "Carousel Pagination" }),
									(xt = Mt.children),
									(0, Hi.forEach)(xt, function (e, t) {
										(0, ji.setAttrs)(e, { "data-nav": t, tabindex: "-1", "aria-label": Et + (t + 1), "aria-controls": je });
									});
							else {
								for (var t = "", n = rt ? "" : 'style="display:none"', i = 0; i < j; i++) t += '<button data-nav="' + i + '" tabindex="-1" aria-controls="' + je + '" ' + n + ' aria-label="' + Et + (i + 1) + '"></button>';
								(t = '<div class="tns-nav" aria-label="Carousel Pagination">' + t + "</div>"), C.insertAdjacentHTML(en(E.navPosition), t), (Mt = C.querySelector(".tns-nav")), (xt = Mt.children);
							}
							if ((xi(), b)) {
							...
							(0, ji.setAttrs)(xt[kt], { "aria-label": Et + (kt + 1) + Ot }), (0, Yi.removeAttrs)(xt[kt], "tabindex"), (0, Ni.addClass)(xt[kt], Lt), (0, Ji.addEvents)(Mt, Ze);
						}
						nt &&
							(gt ||
								(vt && mt) ||
								(C.insertAdjacentHTML(
									en(E.controlsPosition),
									...
									(gt = C.querySelector(".tns-controls"))),
								(vt && mt) || ((vt = gt.children[0]), (mt = gt.children[1])),
								E.controlsContainer && (0, ji.setAttrs)(gt, { "aria-label": "Carousel Navigation", tabindex: "0" }),
								(E.controlsContainer || (E.prevButton && E.nextButton)) && (0, ji.setAttrs)([vt, mt], { "aria-controls": je, tabindex: "-1" }),
								(E.controlsContainer || (E.prevButton && E.nextButton)) && ((0, ji.setAttrs)(vt, { "data-controls": "prev" }), (0, ji.setAttrs)(mt, { "data-controls": "next" })),
								(ht = Fn(vt)),
								(ft = Fn(mt)),
								Yn(),
								gt ? (0, Ji.addEvents)(gt, $e) : ((0, Ji.addEvents)(vt, $e), (0, Ji.addEvents)(mt, $e))),
							Mn();
					}
					function vn() {
						if (V && d) {
						...
						fe && (0, Ji.addEvents)(F, et, E.preventScrollOnTouch),
							ge && (0, Ji.addEvents)(F, tt),
							ae && (0, Ji.addEvents)(O, Qe),
							"inner" === D
								? Fe.on("outerResized", function () {
									yn(), Fe.emit("innerLoaded", Mi());
								})
								: (P || K || Z || ce || !N) && (0, Ji.addEvents)(v, { resize: mn }),
							ce && ("outer" === D ? Fe.on("innerLoaded", Pn) : Ye || Pn()),
							Ln(),
							Ye ? Sn() : qe && _n(),
							Fe.on("indexChanged", Vn),
							"inner" === D && Fe.emit("innerLoaded", Mi()),
							"function" == typeof Ie && Ie(Mi()),
							(G = !0);
					}
					function mn(e) {
						(0, wi.raf)(function () {
					...
					function yn(e) {
						if (G) {
							...
							var t,
								n = B,
								i = !1;
							P && (xn(), (t = n !== B) && Fe.emit("newBreakpointStart", Mi(e)));
							var r,
								a,
								o = ne,
								s = Ye,
							...
							if (
								((ae = rn("arrowKeys")),
									...
									((Ye = rn("disable")),
										...
										(me = rn("autoplayText")),
										(ve = rn("autoplayTimeout")),
										A || ((J = rn("edgePadding")), (Q = rn("gutter")))),
									Xt(Ye),
									(ee = tn()),
									(N && !Z) || Ye || (Bn(), N || (yi(), (i = !0))),
									(K || Z) && ((ke = qn()), (Re = Ae())),
									(t || K) && ((ne = rn("items")), (ie = rn("slideBy")), (a = ne !== o) && (K || Z || (Re = Ae()), Ut())),
									t &&
									Ye !== s &&
									(Ye
										? Sn()
										: (function () {
											if (!Ge) return;
											if (((xe.disabled = !1), (F.className += We), $n(), le)) for (var e = _e; e--;) V && (0, qi.showElement)(W[e]), (0, qi.showElement)(W[Se - e - 1]);
											if (!V)
									...
									(qe
										...
										: ((function () {
											if (!Xe) return;
											J && A && (I.style.margin = "");
											if (_e) for (var e = "tns-transparent", t = _e; t--;) V && (0, Ii.removeClass)(W[t], e), (0, Ii.removeClass)(W[Se - t - 1], e);
											wn(), (Xe = !1);
										})(),
											(i = !0))),
									Xt(Ye || qe),
									pe || (ye = be = !1),
									ae !== c && (ae ? (0, Ji.addEvents)(O, Qe) : (0, Qi.removeEvents)(O, Qe)),
									de !== d &&
									(de ? (gt ? (0, qi.showElement)(gt) : (vt && (0, qi.showElement)(vt), mt && (0, qi.showElement)(mt))) : gt ? (0, Ui.hideElement)(gt) : (vt && (0, Ui.hideElement)(vt), mt && (0, Ui.hideElement)(mt))),
									he !== u && (he ? (0, qi.showElement)(Mt) : (0, Ui.hideElement)(Mt)),
									fe !== h && (fe ? (0, Ji.addEvents)(F, et, E.preventScrollOnTouch) : (0, Qi.removeEvents)(F, et)),
									ge !== f && (ge ? (0, Ji.addEvents)(F, tt) : (0, Qi.removeEvents)(F, tt)),
									pe !== g && (pe ? (Ht && (0, qi.showElement)(Ht), Pt || Vt || oi()) : (Ht && (0, Ui.hideElement)(Ht), Pt && si())),
									ye !== p && (ye ? (0, Ji.addEvents)(F, Ke) : (0, Qi.removeEvents)(F, Ke)),
									be !== v && (be ? (0, Ji.addEvents)(O, Je) : (0, Qi.removeEvents)(O, Je)),
									t)
							) {
								if (((K === y && te === M) || (i = !0), ce !== b && (ce || (I.style.height = "")), de && ue !== x && ((vt.innerHTML = ue[0]), (mt.innerHTML = ue[1])), Ht && me !== w)) {
									var C = pe ? 1 : 0,
										k = Ht.innerHTML,
										T = k.length - w[C].length;
									k.substring(T) === w[C] && (Ht.innerHTML = k.substring(0, T) + me[C]);
								}
							} else te && (K || Z) && (i = !0);
							if (
								((a || (K && !Z)) && ((_t = bi()), xi()),
									(r = Pe !== m) ? (Fe.emit("indexChanged", Mi()), (i = !0)) : a ? r || Vn() : (K || Z) && (Ln(), Nn(), Cn()),
									a &&
									!V &&
									(function () {
										for (var e = Pe + Math.min(j, ne), t = Se; t--;) {
											var n = W[t];
											Pe <= t && t < e
												? ((0, Ni.addClass)(n, "tns-moving"), (n.style.left = (100 * (t - Pe)) / ne + "%"), (0, Ni.addClass)(n, R), (0, Ii.removeClass)(n, H))
												: n.style.left && ((n.style.left = ""), (0, Ni.addClass)(n, H), (0, Ii.removeClass)(n, R)),
												(0, Ii.removeClass)(n, z);
										}
										setTimeout(function () {
											(0, Hi.forEach)(W, function (e) {
								...
								if (t && !A && ((ce === autoheightTem && oe === speedTem) || Rn(), (J === S && Q === _) || (I.style.cssText = an(J, Q, K, oe, ce)), N)) {
					...
					function xn() {
						for (var e in ((B = 0), P)) (e = parseInt(e)) <= Y && (B = e);
					}
					function Mn() {
						!pe && Ht && (0, Ui.hideElement)(Ht), !he && Mt && (0, Ui.hideElement)(Mt), de || (gt ? (0, Ui.hideElement)(gt) : (vt && (0, Ui.hideElement)(vt), mt && (0, Ui.hideElement)(mt)));
					}
					function wn() {
						pe && Ht && (0, qi.showElement)(Ht), he && Mt && (0, qi.showElement)(Mt), de && (gt ? (0, qi.showElement)(gt) : (vt && (0, qi.showElement)(vt), mt && (0, qi.showElement)(mt)));
					}
					function _n() {
						if (!Xe) {
							if ((J && (I.style.margin = "0px"), _e)) for (var e = "tns-transparent", t = _e; t--;) V && (0, Ni.addClass)(W[t], e), (0, Ni.addClass)(W[Se - t - 1], e);
							Mn(), (Xe = !0);
						}
					}
					function Sn() {
						if (!Ge) {
							...
							if (((N && V) || (0, Yi.removeAttrs)(I, ["style"]), !V))
								for (var t = Pe, n = Pe + j; t < n; t++) {
									var i = W[t];
									(0, Yi.removeAttrs)(i, ["style"]), (0, Ii.removeClass)(i, R), (0, Ii.removeClass)(i, H);
								}
							Mn(), (Ge = !0);
						}
					}
					...
					function Tn(e) {
						...
						var n,
							...
							r,
							a = Pe;
						if ((te || J ? (Z || K) && ((i = -(parseFloat(e) + J)), (r = i + ee + 2 * J)) : Z && ((i = L[Pe]), (r = i + ee)), Z))
							L.forEach(function (e, t) {
								t < Se && ((te || J) && e <= i + 0.5 && (a = t), 0.5 <= r - e && (n = t));
							});
						else {
							if (K) {
								var t = K + Q;
					...
					function Ln() {
						Me &&
							!Ye &&
							An.apply(null, Tn()).forEach(function (e) {
								if (!(0, Bi.hasClass)(e, ct)) {
									var t = {};
									(t[d] = function (e) {
										e.stopPropagation();
									}),
					...
					function An(e, t) {
						for (var n = []; e <= t;)
							(0, Hi.forEach)(W[e].querySelectorAll("img"), function (e) {
								n.push(e);
							}),
								e++;
						return n;
					...
					function Dn(n, e) {
						return U
							...
							: (n.forEach(function (e, t) {
								(0, Bi.hasClass)(e, ct) && n.splice(t, 1);
							}),
								n.length
									? void (0, wi.raf)(function () {
										Dn(n, e);
									})
									: e());
					}
						...
						Ln(),
							...
							(function () {
								if (he && ((kt = 0 <= Ct ? Ct : Jt()), (Ct = -1), kt !== Tt)) {
									var e = xt[Tt],
										t = xt[kt];
									(0, ji.setAttrs)(e, { tabindex: "-1", "aria-label": Et + (Tt + 1) }),
										(0, Ii.removeClass)(e, Lt),
										(0, ji.setAttrs)(t, { "aria-label": Et + (kt + 1) + Ot }),
										(0, Yi.removeAttrs)(t, "tabindex"),
										(0, Ni.addClass)(t, Lt),
										(Tt = kt);
								}
							})();
					...
					function Nn() {
						...
						(0, Hi.forEach)(W, function (e, t) {
							n <= t && t <= i
								? (0, Fi.hasAttr)(e, "aria-hidden") && ((0, Yi.removeAttrs)(e, ["aria-hidden", "tabindex"]), (0, Ni.addClass)(e, lt))
								: (0, Fi.hasAttr)(e, "aria-hidden") || ((0, ji.setAttrs)(e, { "aria-hidden": "true", tabindex: "-1" }), (0, Ii.removeClass)(e, lt));
						});
					}
					function In(e) {
					...
					function Zn(e) {
						null == e && (e = Xn()), (F.style[Le] = Ee + e + Oe);
					}
					function Kn(e, t, n, i) {
						var r = e + ne;
						le || (r = Math.min(r, Se));
						...
						if (V || Ne) {
							if ((Fe.emit("transitionEnd", Mi(e)), !V && 0 < we.length))
								for (var t = 0; t < we.length; t++) {
									var n = we[t];
									(n.style.left = ""), c && l && ((n.style[c] = ""), (n.style[l] = "")), (0, Ii.removeClass)(n, z), (0, Ni.addClass)(n, H);
								}
						...
						if (!qe)
							if ("prev" === e) ni(t, -1);
								...
								var n = Kt(),
									i = 0;
								if (
									("first" === e ? (i = -n) : "last" === e ? (i = V ? j - ne - n : j - 1 - n) : ("number" != typeof e && (e = parseInt(e)), isNaN(e) || (t || (e = Math.max(0, Math.min(j - 1, e))), (i = e - n))),
										!V && i && Math.abs(i) < ne)
								) {
									var r = 0 < i ? 1 : -1;
					...
					function ri() {
						clearInterval(At), (Pt = !1);
					}
					function ai(e, t) {
						(0, ji.setAttrs)(Ht, { "data-action": e }), (Ht.innerHTML = Nt[0] + e + Nt[1] + t);
					}
					function oi() {
						ii(), Ht && ai("stop", me[1]);
					}
					...
					function gi() {
						return (0, zi.getTouchDirection)((0, Ri.toDegree)(jt.y - Wt.y, jt.x - Wt.x), He) === E.axis;
					}
					function pi(e) {
						if (Ne) {
							if (ze) return;
						...
						var t = di(e);
						Fe.emit(hi(e) ? "touchStart" : "dragStart", Mi(e)),
							!hi(e) && 0 <= ["img", "a"].indexOf(In(ui(e))) && fi(e),
							(jt.x = Wt.x = t.clientX),
							(jt.y = Wt.y = t.clientY),
							V && ((It = parseFloat(F.style[Le].replace(Ee, ""))), Gn(F, "0s"));
					}
					function vi(e) {
						if (Yt) {
							var t = di(e);
							(jt.x = t.clientX),
								...
								V
									? (Ft =
										...
										(0, wi.raf)(function () {
											!(function e(t) {
												if (!Be) return void (Yt = !1);
												(0, _i.caf)(Ft);
												Yt &&
													(Ft = (0, wi.raf)(function () {
														e(t);
													}));
												"?" === Be && (Be = gi());
												if (Be) {
					...
					function mi(i) {
						if (Yt) {
							...
							if (Math.abs(r)) {
								if (!hi(i)) {
									...
									(0, Ji.addEvents)(n, {
										click: function e(t) {
											fi(t), (0, Qi.removeEvents)(n, { click: e });
										},
									});
								}
								V
									? (Ft = (0, wi.raf)(function () {
										if (N && !Z) {
											...
											else for (var n = 0; n < Se && t >= L[n];) t > L[(Pe = n)] && r < 0 && (Pe += 1), n++;
										}
						...
						"auto" === E.preventScrollOnTouch && (ut = !1), He && (Be = "?"), pe && !Pt && ii();
					}
					function yi() {
					...
					h && console.warn("No slides found in", E.container);
				};
			},
			{
		...
		48: [
			function (e, t, n) {
				...
				e("./global/page-loader"),
					...
					e("./form/form-switch"),
					e("./form/form-input"),
					e("./form/interactive-input"),
					e("./landing/landing.tabs"),
					e("./header/header.progressBar"),
					e("./header/header.dropdown"),
					e("./sidebar/sidebar"),
					e("./global/user-avatar.hexagons"),
					e("./global/maps"),
					e("./content/content.progressBar"),
					e("./content/content.slider"),
					e("./content/content.dropdown"),
					e("./content/content.tab"),
					e("./global/charts"),
					e("./widget/twitter");
			},
			{
		...
		49: [
			function (e, t, n) {
				...
				i.createDropdown({
					...
					animation: { type: "translate-top", speed: 0.3, translateOffset: { vertical: 20 } },
				}),
					i.createDropdown({
						...
						animation: { type: "translate-bottom", speed: 0.3, translateOffset: { vertical: 20 } },
					}),
					i.createDropdown({
					...
					i.createDropdown({
						...
						animation: { type: "translate-bottom", speed: 0.3, translateOffset: { vertical: 16 } },
						closeOnDropdownClick: !0,
					}),
					i.createDropdown({
		...
		50: [
			function (e, t, n) {
				"use strict";
				var i = e("../utils/plugins");
				i.createProgressBar({ container: "#exp-to-next-level", height: 6, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-bronze", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-silver", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-gold", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-platinum", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-traveller", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-caffeinated", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-upowered", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-scientist", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-ncreature", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-warrior", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-liked", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-sloved", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-qconq", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-villain", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-age", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
						container: "#badge-age",
						height: 4,
						gradient: { colors: ["#615dfa", "#41efff"] },
					...
					i.createProgressBar({ container: "#badge-tstruck", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-uexp", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-globet", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-verifieds", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-gempost", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-peoplesp", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-rulerm", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-marketeer", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-tycoon", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-mightiers", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-phantom", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-forumsf", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-fcultivator", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-splanner", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-collector", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-prophoto", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-rmachine", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-bronzec", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-silverc", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-goldc", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#badge-platinumc", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#quest-preview-nth", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-preview-nth", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 65 }, animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-preview-sk", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-preview-sk", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 85 }, animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-preview-bp", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-preview-bp", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 32 }, animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-preview-htp", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-preview-htp", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 0 }, animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-preview-sm", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-preview-sm", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 49 }, animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-sk", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-sk", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 8, stop: 7 }, linkText: !0, linkUnits: "/" }),
					i.createProgressBar({ container: "#quest-fu", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-fu", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 50, stop: 50 }, linkText: !0, linkUnits: "/" }),
					i.createProgressBar({ container: "#quest-nth", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-nth", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 67 }, linkText: !0, linkUnits: "%" }),
					i.createProgressBar({ container: "#quest-sm", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-sm", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 10, stop: 5 }, linkText: !0, linkUnits: "/" }),
					i.createProgressBar({ container: "#quest-line-ps", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-ps", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 100 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-nth", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-nth", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 67 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-fu", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-fu", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 50, stop: 50 }, linkText: !0, linkUnits: "/", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-ph", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-ph", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 20, stop: 20 }, linkText: !0, linkUnits: "/", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-tr", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-tr", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 10, stop: 2 }, linkText: !0, linkUnits: "/", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-sk", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-sk", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 8, stop: 7 }, linkText: !0, linkUnits: "/", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-bp", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-bp", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 30, stop: 12 }, linkText: !0, linkUnits: "/", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-htp", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-htp", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 0 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#quest-line-sm", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#quest-line-sm", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 10, stop: 5 }, linkText: !0, linkUnits: "/", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#poll-result-1", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#poll-result-1", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 62 }, linkText: !0, linkUnits: "%" }),
					i.createProgressBar({ container: "#poll-result-2", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#poll-result-2", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 27 }, linkText: !0, linkUnits: "%" }),
					i.createProgressBar({ container: "#poll-result-3", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#poll-result-3", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 11 }, linkText: !0, linkUnits: "%" }),
					i.createProgressBar({ container: "#post-engagement-1", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#post-engagement-1", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 89 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#post-engagement-2", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#post-engagement-2", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 74 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#post-engagement-3", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#post-engagement-3", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 53 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#post-engagement-4", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#post-engagement-4", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 48 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#post-engagement-5", height: 4, lineColor: "#e7e8ee" }),
					i.createProgressBar({ container: "#post-engagement-5", height: 4, gradient: { colors: ["#615dfa", "#41efff"] }, scale: { start: 0, end: 100, stop: 21 }, linkText: !0, linkUnits: "%", animateOnScroll: !0 }),
					i.createProgressBar({ container: "#top-country-1", width: 178, height: 6, lineColor: "#e7e8ee" }),
					i.createProgressBar({
						...
						split: { parts: 30, gap: 2, color: "#fff" },
						linkText: !0,
						linkUnits: !1,
						animateOnScroll: !0,
					}),
					i.createProgressBar({ container: "#top-country-2", width: 178, height: 6, lineColor: "#e7e8ee" }),
					i.createProgressBar({
					...
					i.createProgressBar({ container: "#top-country-3", width: 178, height: 6, lineColor: "#e7e8ee" }),
					i.createProgressBar({
		...
		51: [
			function (e, t, n) {
				...
				o.createSlider({
					...
					o.createSlider({ container: "#section-navigation-slider", fixedWidth: 122, nav: !1, loop: !1, controlsContainer: "#section-navigation-slider-controls" }),
					o.createSlider({ container: "#section-navigation-medium-slider", fixedWidth: 160, nav: !1, loop: !1, controlsContainer: "#section-navigation-medium-slider-controls" }),
					o.createSlider({ container: "#user-stats-slider", fixedWidth: 113, nav: !1, loop: !1, controlsContainer: "#user-stats-slider-controls" }),
					o.createSlider({ container: "#reaction-stats-slider", fixedWidth: 146, nav: !1, loop: !1, controlsContainer: "#reaction-stats-slider-controls" }),
					o.createSlider({ container: "#stat-block-slider", fixedWidth: 272, nav: !1, loop: !1, controlsContainer: "#stat-block-slider-controls" }),
					o.createSlider({ container: "#stream-slider", fixedWidth: 184, gutter: 16, nav: !1, controlsContainer: "#stream-slider-controls" }),
					o.createSlider({ container: "#stats-box-slider-items", mode: "gallery", nav: !1, speed: 1e3, autoplay: !0, autoplayButtonOutput: !1, controlsContainer: "#stats-box-slider-controls" }),
					o.createSlider({ container: "#reaction-stat-slider-items", nav: !1, speed: 600, controlsContainer: "#reaction-stat-slider-controls" }),
					o.createSlider({ container: "#badge-stat-slider-items", nav: !1, loop: !1, speed: 600, controlsContainer: "#badge-stat-slider-controls" }),
					o.createSlider({
		...
		58: [
			function (e, t, n) {
				"use strict";
				var i = e("../utils/plugins");
				i.createAccordion({ triggerSelector: ".accordion-trigger", contentSelector: ".accordion-content", startOpenClass: "accordion-open", selectedClass: "selected", linkTriggers: !1 }),
					i.createAccordion({ triggerSelector: ".accordion-trigger-linked", contentSelector: ".accordion-content-linked", startOpenClass: "accordion-open", selectedClass: "selected", linkTriggers: !0 });
			},
			{ "../utils/plugins": 72 },
		],
		59: [
			function (e, t, n) {
				...
				i.querySelector("#engagements-chart", function (e) {
					...
					o.createChart(t, {
						type: "doughnut",
						data: {
							datasets: [{ data: [18.3, 5.2, 1.4, 3.9], backgroundColor: ["#615dfa", "#23d2e2", "#4f91ff", "#3ad2fe"], hoverBackgroundColor: ["#615dfa", "#23d2e2", "#4f91ff", "#3ad2fe"], borderWidth: 0 }],
					...
					i.querySelector("#ve-monthly-report-ratio-chart", function (e) {
						...
						o.createChart(t, {
							type: "doughnut",
							data: { datasets: [{ data: [12.5, 87.5], backgroundColor: ["#615dfa", "#23d2e2"], hoverBackgroundColor: ["#615dfa", "#23d2e2"], borderWidth: 0 }], labels: ["Engagements", "Visits"] },
							options: {
								cutoutPercentage: 74,
								responsive: !0,
								maintainAspectRatio: !1,
					...
					i.querySelector("#ve-monthly-report-chart", function (e) {
						var t = [20, 15, 22, 26, 12, 16, 24, 13, 17, 9, 26, 21, 14, 21, 17, 23, 30, 18, 24, 15, 28, 17, 13, 23, 16, 12, 23, 16, 24, 13, 22],
							...
							r = {
								labels: a(31),
								datasets: [
									{ label: "Engagements", data: t, maxBarThickness: 16, backgroundColor: "#615dfa" },
									{ label: "Visits", data: n, maxBarThickness: 16, backgroundColor: "#3ad2fe" },
									{
										data: (function (e, t) {
											for (var n = new Array(e[0].length).fill(t), i = 0; i < e.length; i++) for (var r = 0; r < e[i].length; r++) n[r] -= e[i][r];
											return n;
										})([t, n], 55),
										maxBarThickness: 16,
						...
						o.createChart(i, {
							...
							options: {
								...
								maintainAspectRatio: !1,
								legend: { display: !1 },
								tooltips: { bodyFontFamily: "'Titillium Web', sans-serif", displayColors: !1, callbacks: { title: function () { } } },
								scales: {
									xAxes: [{ stacked: !0, gridLines: { display: !1 }, ticks: { fontFamily: "'Rajdhani', sans-serif", fontColor: "#8f91ac", fontSize: 12, fontStyle: 500 } }],
									yAxes: [
										{
											stacked: !0,
											gridLines: { color: "rgba(234, 234, 245, 1)", zeroLineColor: "rgba(234, 234, 245, 1)", drawBorder: !1, drawTicks: !1 },
											ticks: { padding: 20, fontFamily: "'Rajdhani', sans-serif", fontColor: "#8f91ac", fontSize: 12, fontStyle: 500, max: 55, stepSize: 5 },
										},
									],
								},
							},
							...
							options: {
								...
								scales: {
									xAxes: [
										{
											gridLines: { color: "rgba(234, 234, 245, 1)", zeroLineColor: "rgba(234, 234, 245, 1)", drawBorder: !1, drawTicks: !1 },
											ticks: { padding: 14, fontFamily: "'Rajdhani', sans-serif", fontColor: "#8f91ac", fontSize: 12, fontStyle: 500 },
										},
									],
									yAxes: [
										{
											gridLines: { color: "rgba(234, 234, 245, 1)", zeroLineColor: "rgba(234, 234, 245, 1)", drawBorder: !1 },
											ticks: { padding: 20, fontFamily: "'Rajdhani', sans-serif", fontColor: "#8f91ac", fontSize: 12, fontStyle: 500, min: 20, max: 220, stepSize: 40 },
										},
									],
								},
							},
					...
					i.querySelector("#vs-performance-chart", function (e) {
						var t = e[0].getContext("2d"),
							n = {
								...
								datasets: [
									{ label: "Views", data: [140, 90, 155, 180], maxBarThickness: 16, backgroundColor: "#615dfa" },
									{ label: "Sales", data: [120, 25, 130, 110], maxBarThickness: 16, backgroundColor: "#3ad2fe" },
								],
							};
						o.createChart(t, {
							type: "bar",
							...
							options: {
								...
								tooltips: { bodyFontFamily: "'Titillium Web', sans-serif", displayColors: !1, callbacks: { title: function () { } } },
								scales: {
									xAxes: [{ gridLines: { display: !1 }, ticks: { fontFamily: "'Rajdhani', sans-serif", fontColor: "#8f91ac", fontSize: 12, fontStyle: 500 } }],
							...
							options: {
								...
								scales: {
									...
									yAxes: [
										{
											gridLines: { color: "rgba(234, 234, 245, 1)", zeroLineColor: "rgba(234, 234, 245, 1)", drawBorder: !1 },
											ticks: { padding: 20, fontFamily: "'Rajdhani', sans-serif", fontColor: "#8f91ac", fontSize: 12, fontStyle: 500, max: 20, stepSize: 2, beginAtZero: !0 },
										},
									],
								},
							},
		...
		60: [
			function (e, t, n) {
				...
				window.initMap = function () {
					new google.maps.Map(document.getElementById("g-map"), { center: { lat: 44.934084, lng: -93.252358 }, zoom: 15, disableDefaultUI: !1 });
				};
			},
			{},
		],
		...
		62: [
			function (e, t, n) {
				...
				var i = e("../utils/plugins"),
					r = e("../utils/core");
				i.createPopup({ container: ".popup-video", trigger: ".popup-video-trigger", sticky: !0, overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
					i.createPopup({ container: ".popup-picture", trigger: ".popup-picture-trigger", sticky: !0, overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
					i.createPopup({ container: ".popup-album-creation", trigger: ".popup-album-creation-trigger", overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
					i.createPopup({ container: ".popup-event-creation", trigger: ".popup-event-creation-trigger", overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
					i.createPopup({
						container: ".popup-event-information",
						trigger: ".popup-event-information-trigger",
						overlay: { color: "21, 21, 31", opacity: 0.96 },
						animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 },
					}),
					i.createPopup({ container: ".popup-manage-group", trigger: ".popup-manage-group-trigger", overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
					i.createPopup({ container: ".popup-manage-item", trigger: ".popup-manage-item-trigger", overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
					i.createPopup({ container: ".popup-review", trigger: ".popup-review-trigger", overlay: { color: "21, 21, 31", opacity: 0.96 }, animation: { type: "translate-in-fade", speed: 0.3, translateOffset: 40 } }),
		...
		63: [
			function (e, t, n) {
				"use strict";
				var i = e("../utils/plugins");
				i.createTooltip({ container: ".text-tooltip-tfr", offset: 4, direction: "right", animation: { type: "translate-in-fade" } }),
					i.createTooltip({ container: ".text-tooltip-tft", offset: 4, direction: "top", animation: { type: "translate-out-fade" } }),
					i.createTooltip({ container: ".text-tooltip-tft-medium", offset: 8, direction: "top", animation: { type: "translate-out-fade" } });
			},
			{ "../utils/plugins": 72 },
		],
		64: [
			function (e, t, n) {
				"use strict";
				var i = e("../utils/plugins");
				i.createHexagon({ container: ".hexagon-148-164", width: 148, height: 164, roundedCorners: !0, fill: !0 }),
					i.createHexagon({ container: ".hexagon-progress-124-136", width: 124, height: 136, lineWidth: 8, roundedCorners: !0, gradient: { colors: ["#41efff", "#615dfa"] }, scale: { start: 0, end: 1, stop: 0.74 } }),
					i.createHexagon({ container: ".hexagon-border-124-136", width: 124, height: 136, lineWidth: 8, roundedCorners: !0, lineColor: "#e7e8ee" }),
					i.createHexagon({ container: ".hexagon-image-100-110", width: 100, height: 110, roundedCorners: !0, clip: !0 }),
					i.createHexagon({ container: ".hexagon-120-132", width: 120, height: 132, roundedCorners: !0, fill: !0 }),
					i.createHexagon({ container: ".hexagon-progress-100-110", width: 100, height: 110, lineWidth: 6, roundedCorners: !0, gradient: { colors: ["#41efff", "#615dfa"] }, scale: { start: 0, end: 1, stop: 0.8 } }),
					i.createHexagon({ container: ".hexagon-border-100-110", width: 100, height: 110, lineWidth: 6, roundedCorners: !0, lineColor: "#e7e8ee" }),
					i.createHexagon({ container: ".hexagon-image-82-90", width: 82, height: 90, roundedCorners: !0, roundedCornerRadius: 3, clip: !0 }),
					i.createHexagon({ container: ".hexagon-100-110", width: 100, height: 110, roundedCorners: !0, fill: !0 }),
					i.createHexagon({
						...
						gradient: { colors: ["#41efff", "#615dfa"] },
						scale: { start: 0, end: 1, stop: 0.8 },
					}),
					i.createHexagon({ container: ".hexagon-border-84-92", width: 84, height: 92, lineWidth: 5, roundedCorners: !0, roundedCornerRadius: 3, lineColor: "#e7e8ee" }),
					i.createHexagon({ container: ".hexagon-image-68-74", width: 68, height: 74, roundedCorners: !0, roundedCornerRadius: 3, clip: !0 }),
					i.createHexagon({ container: ".hexagon-50-56", width: 50, height: 56, roundedCorners: !0, roundedCornerRadius: 2, fill: !0 }),
					i.createHexagon({
					...
					i.createHexagon({ container: ".hexagon-border-40-44", width: 40, height: 44, lineWidth: 3, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#e7e8ee" }),
					i.createHexagon({ container: ".hexagon-image-30-32", width: 30, height: 32, roundedCorners: !0, roundedCornerRadius: 1, clip: !0 }),
					i.createHexagon({ container: ".hexagon-40-44", width: 40, height: 44, roundedCorners: !0, roundedCornerRadius: 1, fill: !0 }),
					i.createHexagon({ container: ".hexagon-dark-32-34", width: 32, height: 34, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#45437f", fill: !0 }),
					i.createHexagon({ container: ".hexagon-32-36", width: 32, height: 36, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#fff", fill: !0 }),
					i.createHexagon({ container: ".hexagon-dark-26-28", width: 26, height: 28, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#45437f", fill: !0 }),
					i.createHexagon({ container: ".hexagon-28-32", width: 28, height: 32, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#fff", fill: !0 }),
					i.createHexagon({ container: ".hexagon-dark-22-24", width: 22, height: 24, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#45437f", fill: !0 }),
					i.createHexagon({ container: ".hexagon-22-24", width: 22, height: 24, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#fff", fill: !0 }),
					i.createHexagon({ container: ".hexagon-dark-16-18", width: 16, height: 18, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "#45437f", fill: !0 }),
					i.createHexagon({ container: ".hexagon-120-130", width: 120, height: 130, roundedCorners: !0, fill: !0 }),
					i.createHexagon({ container: ".hexagon-100-108", width: 100, height: 108, roundedCorners: !0, fill: !0 }),
					i.createHexagon({ container: ".hexagon-image-124-136", width: 124, height: 136, roundedCorners: !0, clip: !0 }),
					i.createHexagon({ container: ".hexagon-image-84-92", width: 84, height: 92, roundedCorners: !0, clip: !0 }),
					i.createHexagon({ container: ".hexagon-34-36", width: 34, height: 36, roundedCorners: !0, roundedCornerRadius: 1, fill: !0 }),
					i.createHexagon({ container: ".hexagon-image-40-44", width: 40, height: 44, roundedCorners: !0, roundedCornerRadius: 1, clip: !0 }),
					i.createHexagon({ container: ".hexagon-image-24-26", width: 24, height: 26, roundedCorners: !0, roundedCornerRadius: 1, clip: !0 }),
					i.createHexagon({ container: ".hexagon-image-18-20", width: 18, height: 20, roundedCorners: !0, roundedCornerRadius: 1, clip: !0 }),
					i.createHexagon({ container: ".hexagon-overlay-30-32", width: 30, height: 32, roundedCorners: !0, roundedCornerRadius: 1, lineColor: "rgba(97, 93, 250, .9)", fill: !0 });
			},
			{ "../utils/plugins": 72 },
		],
		65: [
			function (e, t, n) {
				...
				e("../utils/core").querySelector("#search-main", function (e) {
					...
					o.createDropdown({ trigger: ".header-dropdown-trigger", container: ".header-dropdown", offset: { top: 64, right: 6 }, animation: { type: "translate-top" } }),
					o.createDropdown({ trigger: ".header-settings-dropdown-trigger", container: ".header-settings-dropdown", offset: { top: 64, right: 22 }, animation: { type: "translate-top" } });
			},
			{ "../utils/core": 69, "../utils/plugins": 72 },
		],
		66: [
			function (e, t, n) {
				"use strict";
				var i = e("../utils/plugins");
				i.createProgressBar({ container: "#logged-user-level", height: 4, lineColor: "#4a46c8" }),
					i.createProgressBar({ container: "#logged-user-level", height: 4, lineColor: "#41efff", scale: { start: 0, end: 100, stop: 62 }, linkText: !0, linkUnits: "exp", invertedProgress: !0 }),
					i.createProgressBar({ container: "#logged-user-level-cp", height: 4, lineColor: "#4a46c8" }),
					i.createProgressBar({ container: "#logged-user-level-cp", height: 4, lineColor: "#41efff", scale: { start: 0, end: 100, stop: 62 }, linkText: !0, linkUnits: "exp", invertedProgress: !0 });
			},
			{ "../utils/plugins": 72 },
		],
		67: [
			...
			function (e, t, n) {
				...
				r.querySelector(".content-grid", function (o) {
					...
					l(),
						...
						r.querySelector("#chat-widget-messages", function (e) {
							function t() {
							...
							m.addEventListener("click", function () {
								...
								r.querySelector("#chat-widget-message", function (e) {
									function t() {
						...
						r.querySelector(".navigation-widget-mobile-trigger", function (e) {
							...
							(r.style.width = "100%"),
								...
								(r.style.backgroundColor = "rgba(21, 21, 31, .96)"),
								(r.style.opacity = 0),
								(r.style.visibility = "hidden"),
								(r.style.transition = "opacity .3s ease-in-out, visibility .3s ease-in-out"),
			...
			function (e, t, n) {
				...
				var r = {
						...
						return (
							...
							new Promise(function (e, t) {
								...
								(n.onreadystatechange = function () {
									4 === n.readyState && (200 === n.status ? e(n.responseText) : t({ status: n.status, statusText: n.statusText }));
								}),
									n.open(i.method, i.url, i.async),
									n.setRequestHeader(i.header.type, i.header.value),
									"GET" === i.method ? n.send() : "POST" === i.method && n.send(i.data);
							})
						);
					},
					...
					dateDiff: function (e, t) {
						...
						return r < 60
							? { unit: 1 === r ? "second" : "seconds", value: r }
							: a < 60
								? { unit: 1 === a ? "minute" : "minutes", value: a }
								: o < 24
									? { unit: 1 === o ? "hour" : "hours", value: o }
									: s < 7
										? { unit: 1 === s ? "day" : "days", value: s }
										: l < 4
											? { unit: 1 === l ? "week" : "weeks", value: l }
											: c < 12
												? { unit: 1 === c ? "month" : "months", value: c }
												: { unit: 1 === d ? "year" : "years", value: d };
					},
				};
				t.exports = r;
			},
			...
			function (e, t, n) {
				...
				e("./core").querySelector(".icon-demo-list", function (e) {
					function t(e) {
						...
						return (
							t.classList.add("demo-box"),
							n.classList.add("demo-box-icon-wrap"),
							i.classList.add("demo-box-icon"),
							r.classList.add("demo-box-title"),
							a.classList.add("demo-box-text"),
							o.classList.add("button", "full"),
							s.classList.add("inactive-text"),
							l.classList.add("active-text"),
							(r.innerHTML = e.name),
							(a.innerHTML = ".icon-".concat(e.className)),
							(s.innerHTML = "Copy SVG"),
							(l.innerHTML = "Copied!"),
							n.appendChild(i),
							t.appendChild(n),
							t.appendChild(r),
							...
							o.appendChild(l),
							t.appendChild(o),
							{ container: t, trigger: o }
						);
					}
					var n = [
						{ name: "Facebook", className: "facebook" },
						{ name: "Twitter", className: "twitter" },
						{ name: "Twitch", className: "twitch" },
						{ name: "Youtube", className: "youtube" },
						{ name: "Instagram", className: "instagram" },
						{ name: "Discord", className: "discord" },
						{ name: "Patreon", className: "patreon" },
						{ name: "Google", className: "google" },
						{ name: "Behance", className: "behance" },
						{ name: "DeviantArt", className: "deviantart" },
						{ name: "Artstation", className: "artstation" },
						{ name: "Cross", className: "cross" },
						{ name: "Logo Vikinger", className: "logo-vikinger" },
						{ name: "Grid", className: "grid" },
						{ name: "Dots", className: "dots" },
						{ name: "Magnifying Glass", className: "magnifying-glass" },
						{ name: "Comment", className: "comment" },
						{ name: "Thumbs Up", className: "thumbs-up" },
						{ name: "Friend", className: "friend" },
						{ name: "Group", className: "group" },
						{ name: "Marketplace", className: "marketplace" },
						{ name: "Add Friend", className: "add-friend" },
						{ name: "Remove Friend", className: "remove-friend" },
						{ name: "Delete", className: "delete" },
						{ name: "Messages", className: "messages" },
						{ name: "Send Message", className: "send-message" },
						{ name: "Back Arrow", className: "back-arrow" },
						{ name: "Shopping Bag", className: "shopping-bag" },
						{ name: "Notification", className: "notification" },
						{ name: "Settings", className: "settings" },
						{ name: "Cross Thin", className: "cross-thin" },
						{ name: "Newsfeed", className: "newsfeed" },
						{ name: "Overview", className: "overview" },
						{ name: "Members", className: "members" },
						{ name: "Badges", className: "badges" },
						{ name: "Quests", className: "quests" },
						{ name: "Streams", className: "streams" },
						{ name: "Events", className: "events" },
						{ name: "Forums", className: "forums" },
						{ name: "Small Arrow", className: "small-arrow" },
						{ name: "Big Arrow", className: "big-arrow" },
						{ name: "Public", className: "public" },
						{ name: "Private", className: "private" },
						{ name: "Join Group", className: "join-group" },
						{ name: "Leave Group", className: "leave-group" },
						{ name: "More Dots", className: "more-dots" },
						{ name: "Profile", className: "profile" },
						{ name: "Timeline", className: "timeline" },
						{ name: "Photos", className: "photos" },
						{ name: "Videos", className: "videos" },
						{ name: "Blog Posts", className: "blog-posts" },
						{ name: "Forum", className: "forum" },
						{ name: "Store", className: "store" },
						{ name: "Star", className: "star" },
						{ name: "Play", className: "play" },
						{ name: "Share", className: "share" },
						{ name: "Pinned", className: "pinned" },
						{ name: "Status", className: "status" },
						{ name: "Big Grid View", className: "big-grid-view" },
						{ name: "Small Grid View", className: "small-grid-view" },
						{ name: "List Grid View", className: "list-grid-view" },
						{ name: "Plus", className: "plus" },
						{ name: "Plus Small", className: "plus-small" },
						{ name: "Minus Small", className: "minus-small" },
						{ name: "Poll", className: "poll" },
						{ name: "Camera", className: "camera" },
						{ name: "Gif", className: "gif" },
						{ name: "Tags", className: "tags" },
						{ name: "Quote", className: "quote" },
						{ name: "Pin", className: "pin" },
						{ name: "Ticket", className: "ticket" },
						{ name: "Events Monthly", className: "events-monthly" },
						{ name: "Events Weekly", className: "events-weekly" },
						{ name: "Events Daily", className: "events-daily" },
						{ name: "Info", className: "info" },
						{ name: "Check", className: "check" },
						{ name: "Trophy", className: "trophy" },
						{ name: "Clock", className: "clock" },
						{ name: "Return", className: "return" },
						{ name: "Dribbble", className: "dribbble" },
						{ name: "Item", className: "item" },
						{ name: "Wallet", className: "wallet" },
						{ name: "Earnings", className: "earnings" },
						{ name: "Revenue", className: "revenue" },
						{ name: "Login", className: "login" },
					],
						l = document.createElement("div");
					(l.style.width = "80px"), (l.style.position = "fixed"), (l.style.top = "80px"), (l.style.left = "0"), document.body.appendChild(l);
					var i = !0,
						r = !1,
						a = void 0;
					try {
										...
										c.appendChild(s.container),
											s.trigger.addEventListener("click", function () {
												var e,
													...
													n,
													i = "\n    \x3c!-- ICON "
														.concat((e = o).name.toUpperCase(), ' --\x3e\n    <svg class="icon-')
														.concat(e.className, '">\n      <use xlink:href="#svg-')
														.concat(e.className, '"></use>\n    </svg>\n    \x3c!-- /ICON ')
														.concat(e.name.toUpperCase(), " --\x3e");
												(t = i),
													((n = document.createElement("textarea")).innerHTML = t),
													document.body.appendChild(n),
													n.select(),
													document.execCommand("copy"),
													n.remove(),
													s.trigger.classList.add("active"),
													window.setTimeout(function () {
														s.trigger.classList.remove("active");
													}, 2e3);
												var r,
												...
												(a.style.display = "flex"),
													...
													(a.innerHTML = "\n    \x3c!-- ICON "
														.concat((r = o).name.toUpperCase(), ' --\x3e\n    <svg class="icon-')
														.concat(r.className, ' demo-icon">\n      <use xlink:href="#svg-')
														.concat(r.className, '"></use>\n    </svg>\n    \x3c!-- /ICON ')
														.concat(r.name.toUpperCase(), " --\x3e")),
													l.appendChild(a);
											});
									},
									v = d[Symbol.iterator]();
				...
				var r = e("tiny-slider/src/tiny-slider"),
					...
					o = {
						...
						createHexagon: function (e) {
							if (i(e.container) || void 0 !== e.containerElement) return new XM_Hexagon(e);
						},
						createProgressBar: function (e) {
							if (i(e.container)) return new XM_ProgressBar(e);
						},
						createDropdown: function (e) {
							if (((i(e.container) || void 0 !== e.containerElement) && e.controlToggle) || ((i(e.trigger) || void 0 !== e.triggerElement) && (i(e.container) || void 0 !== e.containerElement))) return new XM_Dropdown(e);
						},
				...
				h.querySelector(".tweet-feed", function (s) {
					function l(e) {
						...
						t.classList.add("tweet"),
							n.classList.add("tweet-author"),
							i.classList.add("tweet-author-image", "picture", "tiny", "circle", "liquid"),
							a.classList.add("tweet-author-title"),
							o.classList.add("tweet-author-text"),
							s.classList.add("tweet-text"),
							l.classList.add("tweet-timestamp"),
							i.appendChild(r),
							n.appendChild(i),
							n.appendChild(a),
							n.appendChild(o),
						...
						return (
							...
							r.setAttribute("src", e.user.profile_image_url_https),
							(a.innerHTML = e.user.name),
							(o.innerHTML = "@".concat(e.user.screen_name)),
							...
							(l.innerHTML = "".concat(u.value, " ").concat(u.unit, " ago")),
							h.liquidifyStatic(i, r),
							t
						);
					}
					function c(e) {
					...
					h.query({ url: "includes/getTweets.php?screen_name=YOUR_SCREEN_NAME&count=3" })
						.then(function (e) {
							var t = JSON.parse(e),
								n = !0,
								i = !1,
